...
Get VMI Network Interface Details
    ...
    IF    ${ip_exists} == ${True}
        ${vmi_ip}=    Create Dictionary
        ...    DHCPv4=${${ip_resp["DHCPv4"]["DHCPEnabled"]}}
        ...    Id=${ip_resp["Id"]}
        ...    Description=${ip_resp["Description"]}
        ...    IPv4_Address=${ip_resp["IPv4Addresses"][0]["Address"]}
        ...    IPv4_AddressOrigin=${ip_resp["IPv4Addresses"][0]["AddressOrigin"]}
        ...    Name=${ip_resp["Name"]}
    ...
    ELSE
        ...
        ...    Id=${ip_resp["Id"]}
        ...    Description=${ip_resp["Description"]}
        ...    IPv4StaticAddresses=${ip_resp["IPv4StaticAddresses"]}
        ...    IPv4_Address=${ip_resp["IPv4Addresses"]}
        ...    Name=${ip_resp["Name"]}
        ...    InterfaceEnabled=${${ip_resp["InterfaceEnabled"]}}
    END
