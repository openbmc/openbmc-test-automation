...
Inject OPAL TI
    ...
    ...  git clone --branch ${stable_branch} ${repo_github_url} ${repo_dir_path}
    Shell Cmd  ${cmd_buf}

    Open Connection for SCP
    scp.Put File  ${repo_dir_path}/test_binaries/deadbeef  /tmp
    Pdbg  -a putmem 0x300000f8 < /tmp/deadbeef

    # Clean up the repo once done.
    Shell Cmd  ${cmd_buf}  rm -rf ${repo_dir_path}/${value}
