...
Start SOL Console Logging
    [Documentation]   Stop any running obmc-console-client process started
    ...               by this keyword. 
...
Stop SOL Console Logging
    [Documentation]   Stop any running obmc-console-client process 
    ...               started by Start SOL Console Logging.
