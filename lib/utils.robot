...
...  df -h | grep /media/pnor-ro | wc -l
${total_bmc_ro_file_system_cmd}=
...  df -h | grep /media/rofs | wc -l
...
BMC File System Usage Check
    ...
    ...   ${total_pnor_ro_file_system_cmd}  return_stderr=True
    Should Be Empty  ${stderr}
    ${bmc_bmc_fs_usage_output}  ${stderr}  ${rc}=  BMC Execute Command
    ...   ${total_bmc_ro_file_system_cmd}  return_stderr=True
    Should Be Empty  ${stderr}
    ${total_bmc_pnor_image}=  Evaluate  ${bmc_pnor_fs_usage_output}+${bmc_bmc_fs_usage_output}
