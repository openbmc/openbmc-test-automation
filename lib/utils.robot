...
BMC CPU Performance Check
   [Documentation]   Minimal 10% of proc should be free in this instance
    ...
    ${bmc_cpu_usage_output}  ${stderr}=  BMC Execute Command
    ...  ${bmc_cpu_usage_cmd}  return_stderr=True
    Should be empty  ${stderr}
...
BMC Mem Performance Check
    ...
    ${bmc_mem_free_output}  ${stderr}=  BMC Execute Command 
    ...  ${bmc_mem_free_cmd}  return_stderr=True
    Should be empty  ${stderr}

    ${bmc_mem_total_output}  ${stderr}=  BMC Execute Command
    ...  ${bmc_mem_total_cmd}  return_stderr=True
    Should be empty  ${stderr}
...
BMC File System Usage Check
    ...
    ${bmc_fs_usage_output}  ${stderr}=  BMC Execute Command
