...
Documentation  Utilities for automated testing Robot keywords
...
Verify BMC System Model
    ...
    # bmc_model  System type, e.g. Witherspoon.
    ...
    # Return the BMC system model name..
    [Return]  ${ret}
...
Get Boot Progress
    ...
    # Return the boot progress state value.
    [Return]  ${state}
...
New Get Boot Progress
    ...
    # Return the boot progress value,  either  On  or Off.
...
Initiate Power On
    ...
    # Description of argument(s):
    # wait    Indicates to wait for power on.
...
Get Power State
    ...
    # Return the power state as an integer. Either 0 or 1.
    [Return]  ${content["data"]}
...
Create OS Console File Path
    ...
    # Return the OS console file path.
...
Stop Journal Log
    ...
    # Return the contents of the journal log.
    [Return]    ${journal_log}
...
IP Address To Hex String
    ...
    # Return the IP address as a hex string.
    [Return]    ${ip_hex}
...
Get Endpoint Paths
    ...
    # Return the URL paths matching the endpoint value.
    [Return]  ${resp}
...
Get System Power Policy
    ...
    # Return the value of the power policy.
...
Get Auto Reboot
    ...
    # Return the auto reboot setting.
    [Return]  ${setting}
...
Get Number Of BMC Core Dump Files
    ...
    # Return the number of core dumps found.
...
Login To OS Host
    ...
    # Return the login response code (usually 0 or HTTP_OK).
    [Return]  ${resp}
...
Get BMC Boot Count
    ...
    # Return the number of boots done this session.
    [Return]  ${BOOT_COUNT}
...
Get System LED State
    ...
    # Return the LED state, either Off or On.
    [Return]  ${state.rsplit('.', 1)[1]}
...
Get BMC Version
    ...
    # Return the version string of the current active BMC code.
    [Return]  ${output}
...
Get PNOR Version
    ...
    # Return the version string of the current PNOR code.
...
Get PNOR Attributes
    ...
    # Return the PNOR attribute values (dictionary).
    [Return]  ${pnor_attrs}
...
Read Turbo Setting Via REST
    ...
    Should Be Equal As Strings  ${resp.status_code}  ${HTTP_OK}
    # Return the current turbo setting  False or True.
