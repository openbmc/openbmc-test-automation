...
def srequired_plug_in(req_plug_in_names,
    ...
    plug_in_dir_paths               A string which is a colon-delimited list
                                    ...
                                    /afs/rchland.ibm.com/usr6/sunilmam/sandbox/
                                    apollodev/src/aipl/x86/plug_ins/DB_Logging:
                                    /afs/rchland.ibm.com/usr6/sunilmam/sandbox/
                                    apollodev/src/aipl/x86/plug_ins/FFDC:/afs/r
                                    chland.ibm.com/usr6/sunilmam/sandbox/apollo
                                    dev/src/aipl/x86/plug_ins/OS_Console:/afs/r
                                    chland.ibm.com/usr6/sunilmam/sandbox/apollo
                                    dev/src/aipl/x86/plug_ins/Perf_boot_times).
                                    Path values will be stripped from this
                                    list to do the analysis.  Default value is
                                    the AUTOBOOT_PLUG_IN_DIR_PATHS environment
                                    variable.
    """
