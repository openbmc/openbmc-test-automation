...
DES_L2_RECV1 = "'L2FIR[^8].*L2 directory CE due to stuck'"
...
DES_EQ_RECV32 = "'EQ_LFIR[^0].*CFIR internal parity error'"
DES_NCU_RECV1 = "'NCUFIR[^8].*NCU Store Queue Data Parity'"
DES_CORE_RECV1 = 'CORE'
...
ERROR_INJECT_DICT = {'MCACALIFIR_RECV1': ['07010900', '8000000000000000',\
             ...
             'COREFIR_RECV1': ['20010A40', '0000000020000000', DES_CORE_RECV1]
