...
# opal-prd service related commands
opal_prd_state_check_cmd = 'systemctl list-unit-files | grep "opal-prd"'
opal_prd_service_start_cmd = 'service opal-prd start'
opal_prd_service_on_cmd = 'chkconfig opal-prd on'
