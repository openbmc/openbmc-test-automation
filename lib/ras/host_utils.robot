...
Get Core IDs From OS
    ...
    SSHLibrary.File Should Exist  ${probe_cpu_file_path}
    ${cmd}=  Catenate  ${probe_cpu_file_path} | grep -i 'CHIP ID: ${proc_chip_id}'
    ...  | cut -c21-22
...
FIR Address Translation Through HOST
    ...
    SSHLibrary.File Should Exist  ${addr_translation_file_path}
