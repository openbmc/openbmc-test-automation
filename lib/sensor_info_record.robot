...
Validate Threshold Values Are Properly Assigned As Per IPMI Spec
    ...
    FOR  ${sensor_id}  IN  @{sensor_id_sensor_threshold_mapping}
      ...
      Run Keyword If  '${sensor_threshold_values_length}' == '2'
      ...  Validate Two Threshold Values  ${sensor_threshold_values}  ${sensor_id}
      Run Keyword If  '${sensor_threshold_values_length}' == '3'
      ...  Validate Three Threshold Values  ${sensor_threshold_values}  ${sensor_id}
      Run Keyword If  '${sensor_threshold_values_length}' == '4'
      ...  Validate Four Threshold Values  ${sensor_threshold_values}  ${sensor_id}
      Run Keyword If  '${sensor_threshold_values_length}' == '5'
      ...  Validate Five Threshold Values  ${sensor_threshold_values}  ${sensor_id}
      Run Keyword If  '${sensor_threshold_values_length}' == '6'
      ...  Validate Six Threshold Values  ${sensor_threshold_values}  ${sensor_id}
    END
...
Validate Two Threshold Values
    [Documentation]  Compare two threshold values.
    ...
    FOR  ${threshold_key}  IN  @{threshold_keys}
      ...
      Append To List  ${threshold_values}  ${threshold_value}
    END

    FOR  ${value_1}  ${value_2}  IN  @{threshold_values}
      ${key_1}=  Get From List  ${threshold_keys}  0
      ${key_2}=  Get From List  ${threshold_keys}  1
      Run Keyword And Continue On Failure  Should Be True  ${value_1} < ${value_2}
      ...  message= ${sensor_id} threshold value : ${key_1} - ${value_1} and ${key_2} - ${value_2}
    END


Validate Three Threshold Values
    [Documentation]  Compare three threshold values
    [Arguments]  ${sensor_threshold_values}  ${sensor_id}
    ...
    FOR  ${value_1}  ${value_2}  ${value_3}  IN  @{threshold_values}
      ${key_1}=  Get From List  ${threshold_keys}  0
      ${key_2}=  Get From List  ${threshold_keys}  1
      ${key_3}=  Get From List  ${threshold_keys}  2
      Run Keyword And Continue On Failure  Should Be True  ${value_1} < ${value_2} < ${value_3}
      ...  message= ${sensor_id} threshold value : ${key_1} - ${value_1}, ${key_2} - ${value_2} and ${key_3} - ${value_3}
    END


Validate Four Threshold Values
    [Documentation]  Compare four threshold values.
    [Arguments]  ${sensor_threshold_values}  ${sensor_id}
    ...
    FOR  ${value_1}  ${value_2}  ${value_3}  ${value_4}  IN  @{threshold_values}
      ${key_1}=  Get From List  ${threshold_keys}  0
      ${key_2}=  Get From List  ${threshold_keys}  1
      ${key_3}=  Get From List  ${threshold_keys}  2
      ${key_4}=  Get From List  ${threshold_keys}  3
      Run Keyword And Continue On Failure  Should Be True  ${value_1} < ${value_2} < ${value_3} < ${value_4}
      ...  message= ${sensor_id} threshold value : ${key_1} - ${value_1}, ${key_2} - ${value_2}, ${key_3} - ${value_3} and ${key_4} - ${value_4}
    END


Validate Five Threshold Values
    [Documentation]  Compare five threshold values.
    [Arguments]  ${sensor_threshold_values}  ${sensor_id}
    ...
    FOR  ${value_1}  ${value_2}  ${value_3}  ${value_4}  ${value_5}  IN  @{threshold_values}
      ${key_1}=  Get From List  ${threshold_keys}  0
      ${key_2}=  Get From List  ${threshold_keys}  1
      ${key_3}=  Get From List  ${threshold_keys}  2
      ${key_4}=  Get From List  ${threshold_keys}  3
      ${key_5}=  Get From List  ${threshold_keys}  4
      Run Keyword And Continue On Failure  Should Be True  ${value_1} < ${value_2} < ${value_3} < ${value_4} < ${value_5}
      ...  message= ${sensor_id} threshold value : ${key_1} - ${value_1}, ${key_2} - ${value_2}, ${key_3} - ${value_3}, ${key_4} - ${value_4} and ${key_5} - ${value_5}
    END


Validate Six Threshold Values
    [Documentation]  Compare six threshold values.
    [Arguments]  ${sensor_threshold_values}  ${sensor_id}
    ...
    FOR  ${value_1}  ${value_2}  ${value_3}  ${value_4}  ${value_5}  ${value_6}  IN  @{threshold_values}
      ${key_1}=  Get From List  ${threshold_keys}  0
      ${key_2}=  Get From List  ${threshold_keys}  1
      ${key_3}=  Get From List  ${threshold_keys}  2
      ${key_4}=  Get From List  ${threshold_keys}  3
      ${key_5}=  Get From List  ${threshold_keys}  4
      ${key_6}=  Get From List  ${threshold_keys}  5
      Run Keyword And Continue On Failure  Should Be True  ${value_1} < ${value_2} < ${value_3} < ${value_4} < ${value_5} < ${value_6}
      ...  message= ${sensor_id} threshold value : ${key_1} - ${value_1}, ${key_2} - ${value_2}, ${key_3} - ${value_3}, ${key_4} - ${value_4}, ${key_5} - ${value_5} and ${key_6} - ${value_6}
    END
