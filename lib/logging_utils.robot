...
Verify PEL And Redfish Event Log Are Same
     ...
     ${event_entries_lenght}=  Get Length  ${event_entries}

     Run Keyword And Return If  ${pel_records_length} == ${event_entries_lenght} == 0
     ...  Log  No PEL log and event entries found.

     Run Keyword And Return If  ${pel_records_length} != ${event_entries_lenght}
