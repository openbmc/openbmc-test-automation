...
Compare PEL And Redfish Event Log
     ...
     ...  is same as in event log attributes that is EventId, Created.
     ...  in case if the values are not matching then return false.
     ...
     ${src_created_time_value}=  Set Variable  ${pel_src_record['Private Header']["Created at"]}
