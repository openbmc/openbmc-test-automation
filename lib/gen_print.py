...
# the output from the print_ functions (e.g. a file vs. the console), we
# create sprint_time_last_seconds as a list rather than a simple integer so
# that we can store multiple sprint_time_last_seconds values.  Standard print_
# functions defined in this file, will use sprint_time_last_seconds[0] and the
# lprint_ functions will use sprint_time_last_seconds[1].
