...
def get_line_indent(line):
    r"""
    Return the number of spaces at the beginning of the string.
    """
...
def get_arg_name(var,
    ...
    arg_num                         The arg number (1 through n) whose name
                                    you wish to have returned.  If this value
                                    exceeds the number of arguments specified
                                    on the call to the target function,
                                    get_arg_name will simply return a list of
                                    the arguments.  If arg_num contains the
                                    value 0, get_arg_name will return the name
                                    of the target function as specified in the
                                    calling line.  In other words, if the
                                    caller of the target function uses an
                                    alias, the alias name would be returned.
                                    If arg_num is less than zero, an lvalue
                                    will be returned as described in the
                                    following text.  Using the previous
                                    example, an arg_num value of -2 indicates
                                    that the 2nd parm to the left of the "="
                                    ("rc" in this case) should be returned.
                                    An arg_num value of -1 indicates that the
                                    1st parm to the left of the "=" ("out_buf"
                                    in this case) should be returned.  If
                                    arg_num is less than -2, an entire
                                    dictionary is returned.  The keys to the
                                    dictionary for this example would be -2
                                    and -1.
