...
class redfish_request(object):
    ...
    def request_get_method(self, headers, url, timeout=10, verify=False):
        r"""
        Redfish get request.
    ...
    def request_patch_method(self, headers, url, data=None, timeout=10, verify=False):
        r"""
    ...
    def request_post_method(self, headers, url, data=None, timeout=10, verify=False):
        r"""
    ...
    def request_put_method(self, headers, url, files=None ,data=None, timeout=10, verify=False):
        r"""
        Redfish put request.
    ...
    def request_delete_method(self, headers, url, data=None, timeout=10, verify=False):
        r"""
