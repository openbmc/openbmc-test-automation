*** Settings ***
Documentation      BMC DBUS Related Keywords
...
Get DBUS URI List
    [Documentation]  Get the available DBUS URIs from BMC.
    ...
    # Get the service name and its corresponding uris.
...
Generate DBUS URI List
    ...
    FOR  ${item}  IN  @{dbus_uri_list}
        ...
        ${item}=  Remove Unicode Characters  ${item}
...
Execute DBUS Command
    [Documentation]  Execute the DBUS command and return response.
