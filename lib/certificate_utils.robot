...
Get Certificate File Content From BMC
    ...
    ELSE
        ${certificate}    ${stderr}    ${rc}=    Set Variable    ${None}    ${None}    ${None}
    END
...
Delete Certificate Via BMC CLI
    ...
    IF    '${cert_type}' == 'Client'
        ${certificate_file_path}    ${certificate_service}    ${certificate_uri}=    Set Variable
