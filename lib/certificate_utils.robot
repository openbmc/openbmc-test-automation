...
Get Client Certificate Content Via BMC
    [Documentation]  Get client certificate content via BMC cli.
...
Create Certificate File Via Openssl
    ...
    ${cert_data}=
    ...  Run Keyword if  '${cert_format}' == 'Valid_Certificate_Valid_Privatekey'
    ...  OperatingSystem.Get File  ${EXECDIR}${/}cert.pem
    ...  ELSE IF  '${cert_format}' == 'Empty_Certificate_Valid_Privatekey'
    ...  Remove String  ${file_content}  ${cert_content}
    ...  ELSE IF  '${cert_format}' == 'Valid_Certificate_Empty_Privatekey'
    ...  Remove String  ${file_content}  ${private_key_content}
    ...  ELSE IF  '${cert_format}' == 'Empty_Certificate_Empty_Privatekey'
    ...  Remove String  ${file_content}  ${cert_content}  ${private_key_content}
    ...  ELSE IF  '${cert_format}' == 'Expired_Certificate'
    ...  OperatingSystem.Get File  ${EXECDIR}${/}cert.pem
