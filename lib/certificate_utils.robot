...
Replace Certificate Via Redfish
    ...
    #    ${expected_resp}=  Create List  ${HTTP_OK}  ${HTTP_NO_CONTENT}
    #ELSE IF  '${expected_status}' == 'error'
    #    ${expected_resp}=  Create List  ${HTTP_NOT_FOUND}  ${HTTP_INTERNAL_SERVER_ERROR}  ${HTTP_BAD_REQUEST}
    #ELSE
    #    ${expected_resp}=  Create List
    #END
