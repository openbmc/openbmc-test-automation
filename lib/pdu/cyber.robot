*** Settings ***
Documentation   Cyber Protocol Distribution Unit (PDU) library
...
Power Cycle
    ...
    ${connection_status}=  Connect And Login Via SSH
    ...
    # Up Time  : 178 days 22 hours 29 mins 11 secs.+------- Console -----------------------------------------------------------+
    ...
    FOR  ${outlet}  IN  @{outlets}
        ...
        # Select command to execute 2- Turn Off Immediate
        Run Keyword  ${lib_name}.Read
        Run Keyword  ${lib_name}.Write  2
        ...
        # Select command to execute 1- Turn On Immediate
        Run Keyword  ${lib_name}.Read
        Run Keyword  ${lib_name}.Write  1
