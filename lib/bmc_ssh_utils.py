...
def bmc_execute_command(
    ...
    openbmc_host                    If None, use global variable value of OPENBMC_HOST else
                                    user defined open BMC host name.
    ssh_port                        If None, use global variable value of SSH_PORT else
    ...
    # Get global BMC hostname if user defined openbmc_host is not provided.
    if not openbmc_host:
