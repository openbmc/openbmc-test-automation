...
def bmc_execute_command(
    ...
    openbmc_host                    Default uses global value of OPENBMC_HOST else any user defined host IP.
    ssh_port                        Default uses global value of SSH_PORT else any user defined SSH port.
