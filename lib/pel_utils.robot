...
Verify PEL And Redfish Event Log Are Same
    ...
    # event_dict_records dictionary contains all the events where key is "odata.id" and value is event instance.
    ...
    ...  msg=Expected key that is Id not found in nested dictionary.
