...
${OPENBMC_USERNAME}    service
${OPENBMC_PASSWORD}    0penBmc0
${REST_USERNAME}       service
${REST_PASSWORD}       0penBmc0
${OPENBMC_ADMIN_PASSWORD}  0penBmc0
${SERVICE_USER_PASSWORD}   0penBmc0
