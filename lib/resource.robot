...
${OPENBMC_PASSWORD}    Nvidia_123
${REST_USERNAME}       root
${REST_PASSWORD}       Nvidia_123
${OPENBMC_ADMIN_PASSWORD}  Nvidia_123
${SERVICE_USER_PASSWORD}   Nvidia_123

${CHASSIS_ID}  Luna_GPU_Baseboard
