...
################################################################
# Method : SCP Coredump Files                                  #
#          Copies core dumps from BMC If exist on the system   #
################################################################
SCP Coredump Files
    [Documentation]  Copy core dump files from remote to local.
    # Check if core dump exist on the /tmp
    Open Connection And Log In
