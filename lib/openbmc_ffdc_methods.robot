...
Log OS All distros FFDC
    ...
    ...  scp.Get File /tmp/OS_ffdc.txt ${LOG_PREFIX}${cmd[0]}.txt
    ...  AND 
    ...  scp.Get File  /tmp/OS_ffdc.txt  ${LOG_PREFIX}${cmd[0]}.txt
    \    ${ffdc_file_list}=  Smart Combine Lists  ${ffdc_file_list}
    ...      ${ffdc_file_sub_list}
...
OS FFDC Files
    ...
    # If free space is greater than 5MB send output of OS FFDC
    # commands to OS's /tmp.  Otherwise OS /tmp will not be used.
