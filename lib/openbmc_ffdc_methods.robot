...
Log OS SPECIFIC DISTRO FFDC
    ...
    # Example:  filepath="/tmp/sosreport-myhost-FFDC-2019-08-20-pbuaqtk.tar.xz".
    ...
    #           report_basename="sosreport-myhost-FFDC-2019-08-20-pbuaqtk.tar.xz".
...
OS FFDC Files
    ...
    OS Execute Command  rm -rf /tmp/OS_* /tmp/sosreport*FFDC*
    scp.Close Connection
