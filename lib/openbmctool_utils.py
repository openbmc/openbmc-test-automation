...
def collect_service_data(verify=False):
    ...
    # Inventory collected and stored in /tmp/wsbmc010--2018-09-26_17.59.18/inventory.txt
    rc, file_paths = gc.shell_cmd("egrep 'collected and' " + temp_file_path
                                  # + " | sed -re 's#.*/tmp#/tmp#g'",
                                  + " | sed -re 's#[^/]*/#/#'",
                                  quiet=1, print_output=0)
    # Example file_paths value:
    # /tmp/wsbmc010--2018-09-26_17.59.18/inventory.txt
    # /tmp/wsbmc010--2018-09-26_17.59.18/sensorReadings.txt
    # etc.
