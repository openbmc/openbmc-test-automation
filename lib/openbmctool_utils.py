...
def get_fru_status():
    ...
    # Replace spaces with underscores in field names (e.g. "Is a FRU" becomes "Is_a_FRU").
...
def get_fru_print(parse_json=True):
    r"""
    Get the output of the fru print command and return it either as raw JSON data or as a list of dictionaries.
    ...
    parse_json  Indicates that the raw JSON data should parsed into a list of dictionaries.
    """
...
def get_fru_list(parse_json=True):
    r"""
    Get the output of the fru list command and return it either as raw JSON data or as a list of dictionaries.
...
def get_sensors_print():
    ...
    r"""
    Get the output of the sensors print command and return as a list of dictionaries.
    ...
    ...
    """
    rc, output = openbmctool_execute_command("sensors print", print_output=False,
                                             ignore_err=False)
    # Example value for output (partial):
...
def get_sensors_list():
    ...
    r"""
    Get the output of the sensors list command and return as a list of dictionaries.
    ...
    ...
    """
    rc, output = openbmctool_execute_command("sensors list", print_output=False,
                                             ignore_err=False)
    # Example value for output (partial):
    # sensor                 | type         | units     | value    | target
    # OCC0                   | Discrete     | N/A       | Active   | Active
...
def get_openbmctool_version():
    ...
    """
    rc, output = openbmctool_execute_command("-V | cut -f 2 -d ' '", print_output=False,
                                             ignore_err=False)
    return output
