...
class secureboot_utils(object):
    ...
    def get_system_jumper_state(self, jumper_bit_p0, jumper_bit_p1):
        ...
        Description of argument(s):
        jumper_bit_p0  Jumper position bit value for p0
        jumper_bit_p1  Jumper position bit value for p1
        """
    ...
    def get_system_sb_state(self, sb_bit_p0, sb_bit_p1):
        ...
        chip p0 and p1 and return secureboot policy based on the condition

        Description of argument(s):
        sb_bit_p0  secureboot policy bit value for p0
        sb_bit_p1  secureboot policy bit value for p1
        """
