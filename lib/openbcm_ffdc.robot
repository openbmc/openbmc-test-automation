...
openbmc ffdc
    ...
    Log To Console     FFDC Collection Completed
    Log                ${\n}${FFDC_DIR_PATH}
...
Offload files from BMC
    [Documentation]    Copy files to current log directory
    ${con_status}=     Run Keyword And Return Status    Open Connection and scp files
