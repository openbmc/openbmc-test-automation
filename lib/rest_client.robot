...
Upload Image To BMC
    ...
    #                    (specified in Robot Framework Time Format
    #                    e.g. "3 mins").
    # quiet              If enabled, turns off logging to console.
    # kwargs             A dictionary keys/values to be passed directly to
    #                    Post Request.
    # valid_status_codes A list of status codes that are valid for the REST
    #                    post command. This can be specified as a string the
    #                    evaluates to a python object (e.g. [${HTTP_OK}]).
