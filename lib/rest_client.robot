...
Write Attribute
    ...
    # verify_attr   Only used if verify is set to ${TRUE}. The value that
    #               ${attr} should be set to.
    # kwargs        Arguments to the REST call, the first of which should be
    ...
    Should Not Be Empty  ${verify_attr}
    ${value}=  Read Attribute  ${uri}  ${attr}
    Should Be Equal  ${value}  ${verify_attr}
