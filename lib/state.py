...
def get_state(openbmc_host="",
    ...
    if 'uptime' in req_states:
        # Experience has shown that sometimes reading uptime results in a blank
        # value.  Re-structuring the command to make it fail if uptime is
        # blank.  Then calling with wait_until_keyword_succeeds to ensure a
        # non-blank value is obtained.
