...
${HOST}=               -H
${RAW}=                raw
${IPMITOOL_TEMP_PATH}  /tmp/ipmitool
...
Run Dbus IPMI Standard Command
    ...
    ...    ${IPMITOOL_TEMP_PATH} -I dbus ${command}    return_stdout=True
...
Copy ipmitool
    ...
    ...  Run Keywords  Set Suite Variable  ${IPMITOOL_TEMP_PATH}  ${response}
    ...
    Execute Command     chmod +x ${IPMITOOL_TEMP_PATH}
...
Verify Invalid IPMI cmd
    [Documentation]  Verify invalid ipmi cmd.
