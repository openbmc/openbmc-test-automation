...
class bmc_redfish(redfish_plus):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Presently, older version of BMC code may not support redfish which
        leads to unsightly error text being printed out.  This method will
        make an attempt to tolerate this situation.  At some future point when
        all BMCs can be expected to support redfish, this method may be
        considered for deletion.  Also, delete the self.__inited__ test code
        in the login method below.
        """
