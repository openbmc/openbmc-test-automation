...
class bmc_redfish(redfish_plus):
    ...
    def get_attribute(self, path, attribute, default=None, *args, **kwargs):
        ...
        ${attribute}=  Redfish.Get Attribute  /redfish/v1/AccountService
        ...
        return self.get_properties(path, *args, **kwargs).get(attribute, default)

    def get_session_info(self):
        r"""
        Get and return session info as a tuple consisting of session_key and session_location.
        """
