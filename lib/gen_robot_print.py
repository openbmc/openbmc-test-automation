...
def sprint_vars(*args, **kwargs):
    ...
    if 'fmt' in kwargs:
        # Convert format function names from x to gp.x().  This allows the
        # user to specify "fmt=hex_fmt" and have it get translated to
        # "gp.hex_fmr()".
...
#                                   Robot Print Vars
#                                   Robot Print Vars if ${quiet} is set to
#                                   ${0}.
#                                   Robot Print Vars if ${debug} is set to
#                                   ${1}.
#                                   Robot Print Vars to the log instead of to
#                                   the console.
