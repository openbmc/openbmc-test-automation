...
for func_name in func_names:
    ...
    # Create abbreviated aliases (e.g. rqpvarx is an alias for rqprint_varx).
    alias = re.sub("print_", "p", func_name)
    cmd_buf = robot_prefix + "q" + alias + " = " + robot_prefix + "q" +\
        func_name
    if gen_robot_print_debug:
        rprintn(cmd_buf)
    exec(cmd_buf)

    # Create abbreviated aliases (e.g. rdpvarx is an alias for rdprint_varx).
    alias = re.sub("print_", "p", func_name)
    cmd_buf = robot_prefix + "d" + alias + " = " + robot_prefix + "d" +\
        func_name
    if gen_robot_print_debug:
        rprintn(cmd_buf)
    exec(cmd_buf)
