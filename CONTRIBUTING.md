...
-   Documentation strings:
    ...
    -   Doc strings should be just one terse, descriptive sentence.
        ...
        ```
-   Tags:
    -   Create a tag for every test case with a tag that mirrors the test case name as follows:
        ```
...
-   As shown in the prior example, if your function has any arguments, include a
    "Description of argument(s)" section.  This effectively serves as the help
    text for anyone wanting to use or understand your function.  Include real
    data examples wherever possible and applicable.
