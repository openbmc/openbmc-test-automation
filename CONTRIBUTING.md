...
-   General variable naming conventions:
    ...
    -   Words within a variable name should be separated by underscores:
        ...
        ${ProgramPid}
        ```
    -   Use good judgement in choosing variable names that are neither way too short nor
        way too long.
    ...
    -   Avoid having the variable's type as a suffix portion of the name:
        ...
        A possible exception to this rule is when your keyword or function has an ongoing
        need to refer to one piece of data in more than one format (e.g. date_str, date_epoch, etc.).

    -   Consistency of variable names:

        Try to avoid referring to the same data entity by multiple different names.  It creates
        a lot of confusion for the reader.
...
-----------------------
-   The minimum required Python version is 2.7.x.  In the very near future, we will stop supporting python 2
    and will require python 3.
    ...
    -  Each documentation string should be phrased as an **English command**.
       ...
       Correct example:
        ...
        def boot_bmc():
            ...
            # The doc string above is not phrased as a command.
        ```
    -   Doc strings should begin with a summary line which is one terse, descriptive sentence.
