...
Get Temperature Reading Through XCAT
    ...
    : FOR  ${bmc}  IN  @{BMC_LIST}
    \  ${temp_reading}=  Get Rvital Data Through XCAT  ${bmc}  temp
...
Get Fanspeed Through XCAT
    ...
    : FOR  ${bmc}  IN  @{BMC_LIST}
    \  ${fanspeed}=  Get Rvital Data Through XCAT  ${bmc}  fanspeed
    \  Log  \n fanspeed on $[bmc}\n ${fanspeed}
...
Get Voltage Reading XCAT
    ...
    : FOR  ${bmc}  IN  @{BMC_LIST}
    \  ${voltage}=  Get Rvital Data Through XCAT  ${bmc}  voltage
...
Get Wattage Through XCAT
    ...
    : FOR  ${bmc}  IN  @{BMC_LIST}
    \  ${wattage}=  Get Rvital Data Through XCAT  ${bmc}  wattage
