...
For Web UI ( GUI ) Testing setup, please follow instructions  OpenBMC GUI Test Setup Guide
Note: GUI test cases under `gui/` will not work without the above setup completed in your environment.
