...
These documents contain details on developing OpenBMC test code and debugging.
 ...
 - [Corpoarate CLA and Individual CLA](https://github.com/openbmc/docs/blob/master/CONTRIBUTING.md#submitting-changes-via-gerrit-server): Submitting changes via Gerrit server
