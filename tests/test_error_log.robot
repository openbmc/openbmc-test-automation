...
Suite Setup         Verify logging-test And Clear Existing Error Logs
Test Setup          Open Connection And Log In
Test Teardown       Close All Connections
Suite Teardown      Verify logging-test And Clear Existing Error Logs
...
Verify logging-test And Clear Existing Error Logs
    [Documentation]  First, verify that logging-test exists, as it is a
    ...              prerequisite to running these tests. Second, verify that
    ...              the error log is empty, and if not, reboot the BMC to
    ...              clear the log.
