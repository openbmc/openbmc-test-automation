...
Error Log Check At BMC Ready
    [Documentation]  Check error log at BMC "Ready" state.
    [Tags]  Error_Log_Check_At_BMC_Ready
    # 1. Power off.
    # 2. Delete error logsa
    # 3. Reset BMC.
    # 4. On Standby, check if eror log exist.
...
Error Log Check At Host Booted
