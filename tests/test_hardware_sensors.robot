...
Disable Power Redundancy And Verify
   [Documentation]  Verify if power redundancy is disabled.
...
Enable Power Redundancy And Verify
   [Documentation]  Verify if power redundancy is enabled.
...
Power Redundancy Setting
    [Documentation]  Set and Get power redundancy setting.
