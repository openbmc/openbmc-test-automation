...
Minimum Inventory
    ...
    [Argumen]  ${inventory_name}  ${minimum_count}
    # Description of arguments:
    # inventory_name  Inventory Name (example: fan/cpu/dimm/etc)
    # minimum_count   The number of users defined minimum inventory count.

    ${count}=  Get Total Inventory Present  ${inventory_name}
    Should Be True  ${count}>=${minimum_count}

Get Total Inventory Present
    ...
    ${list}=  Get Endpoint Paths  ${HOST_INVENTORY_URI}/system/  ${inventory_name}
