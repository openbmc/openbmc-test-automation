...
CPU Present
    [Documentation]  Verify the IPMI sensor for present.
...
CPU Not Present
    [Documentation]  Verify the IPMI sensor for not present.
...
CPU Functional
    [Documentation]  Verify the IPMI sensor for Functional.
...
CPU Not Functional
    [Documentation]  Verify the IPMI sensor for Not Functional.
...
Set Operating System State To PXEBoot And Verify
...
Check Present Bit
    [Documentation]  Set the Present Field to 1
    [Arguments]  ${Sensor_id}  ${Comp}

    Run IPMI Command  0x04 0x30 ${Sensor_id} 0xa9 0x00 0x80 0x00 0x00 0x00 0x00 0x20 0x00
    Verify The Attribute
...
Check Not Present Bit
    ...
    Run IPMI Command  0x04 0x30 ${Sensor_id} 0xa9 0x00 0x00 0x00 0x80 0x00 0x00 0x20 0x00
    Verify The Attribute
    ...  ${HOST_INVENTORY_URI}system/chassis/motherboard/${Comp}  Present  ${0}

Check Functional Bit
    [Documentation]  Set the Functional to 1
    [Arguments]  ${Sensor_id}  ${Comp}

    Run IPMI Command  0x04 0x30 ${Sensor_id} 0x00 0x00 0x00 0x00 0x00 0x01 0x00 0x20 0x00
    Verify The Attribute
    ...  ${HOST_INVENTORY_URI}system/chassis/motherboard/${Comp}  Functional  ${1}

Check Not Functional Bit
    [Documentation]  Set the Functional to 0
    [Arguments]  ${Sensor_id}  ${Comp}

    Run IPMI Command  0x04 0x30 ${Sensor_id} 0xa9 0xff 0x00 0x01 0x00 0x00 0x00 0x20 0x00
    Verify The Attribute
    ...  ${HOST_INVENTORY_URI}system/chassis/motherboard/${Comp}  Functional  ${0}

Check OperatingSystemState
    [Documentation]  Set Operating System State
    [Arguments]  ${Sensor_ID}  ${OperatingSystemState}

    Run IPMI Command  0x04 0x30 0x05 0xa9 0x00 ${sensor_id} 0x00 0x00 0x00 0x00 0x00 0x00
    ${resp}=  Read Attribute  ${SYSTEM_STATE_URI}/host0  OperatingSystemState
    Should Be Equal  ${OperatingSystemState}  ${resp}

Check BootProgress
    [Documentation]  Set the Bootprogress
    [Arguments]  ${BootProgressID}  ${BootProgress}

    Run IPMI Command  0x04 0x30 0x03 0xa8 0x00 0x04 0x00 0x00 0x00 0x00 ${BootProgressID} 0x00
