...
Retrieve Default Gateway Via IPMI And Verify Using REST
    ...
    ${default_gw_rest}=  Read Attribute  ${XYZ_NETWORK_MANAGER}/config
    ...  DefaultGateway
    Should Be Equal  ${def_gateway_ipmi}  ${default_gw_rest}
    ...  msg=Verification of default gateway from lan print using IPMI failed.
...
Retrieve IP Address Via IPMI And Verify Using REST
    [Documentation]  Retrieve IP address from lan print using IPMI.
    [Tags]  Retrieve_IP_Address_Via_IPMI_And_Verify_Using_REST
