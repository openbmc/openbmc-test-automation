...
Do Watchdog Reset Via IPMI And Verify Using REST
    [Documentation]  Do watchdog reset via IPMI and verify using REST.
    [Tags]  Do_Watchdog_Reset_Via_IPMI_And_Verify_Using_REST
    ...
    Should Be True
    ...  ${watchdog_time_rem}<${1200000} and ${watchdog_time_rem}>${2000}
    ...  msg=Watchdog timer didn't reset.

Do Watchdog Off Via IPMI And Verify Using REST
    [Documentation]  Do watchdog Off via IPMI and verify using REST.
    [Tags]  Do_Watchdog_Off_Via_IPMI_And_Verify_Using_REST
