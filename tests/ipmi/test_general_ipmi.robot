...
Verify Get And Set Management Controller ID String
    ...
    # Set the mnagement controller ID string to other value
    ${set_mc_id_string}=  Run Keyword
    ...  Run IPMI Standard Command  dcmi set_mc_id_string {HOST}
    Should Contain  ${set_mc_id_string}  {HOST}

    # Set back the value to previous string and verify
    ${setback_mc_id_string}=  Run Keyword
    ...  Run IPMI Standard Command  dcmi set_mc_id_string ${fetch_value}
    ${set_get_mc_id_string}=  Run Keyword
    ...  Run IPMI Standard Command  dcmi get_mc_id_string
