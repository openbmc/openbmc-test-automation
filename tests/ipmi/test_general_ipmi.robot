...
Suite Setup Execution
    ...
    # Fetch the Values of IP, default gateway and subnet mask.
    ${ip_address_old}=  Fetch Details From LAN Print  IP Address
    ${default_gateway_old}=  Fetch Details From LAN Print  Default Gateway IP
    ${subnet_mask_old}=  Fetch Details From LAN Print  Subnet Mask
