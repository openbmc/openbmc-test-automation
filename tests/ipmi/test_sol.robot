...
Verify SOL During Boot
    ...
    ...  ELSE  Run Keywords
    ...  Initiate Host PowerOff Via External IPMI  AND
    ...  Initiate Host Boot Via External IPMI  wait=${0}

    Activate SOL Via IPMI
    Wait Until Keyword Succeeds  10 min  15 sec  Does SOL Contain  Petitboot
...
Does SOL Contain
    ...
    #${rc}  ${output}=  Run and Return RC and Output  cat /tmp/sol_${OPENBMC_HOST}
