...
Set Network Override Setting
    [Documentation]  Set network override settings with passed arguments and
    ...              return its status.
    ...              Description of arguments:
    ...              settings  Network settings which needs to be set
    [Arguments]    ${settings}
    ${network_override}=  Set Variable   ${settings}
...
Post Test Execution
    ...
    ...              default values for network settings override.
