...
Add New Valid IP And Verify
    ...
    Configure Network Settings  ${valid_ip}  ${prefix_len}  ${valid_gw}
    ...                         valid
...
Configure Out Of Range IP
    # IP Address        Prefix_length  Gateway_IP
    ${out_of_range_ip}  ${prefix_len}  ${valid_gw}
...
Configure Broadcast IP
    # IP Address     Prefix_length  Gateway_IP
    ${broadcast_ip}  ${prefix_len}  ${valid_gw}
...
Configure Multicast IP
    # IP Address     Prefix_length  Gateway_IP
    ${multicast_ip}  ${prefix_len}  ${valid_gw}
...
Configure Loopback IP
    # IP Address    Prefix_length  Gateway_IP
    ${loopback_ip}  ${prefix_len}  ${valid_gw}
...
Configure Network ID
    # IP Address   Prefix_length  Gateway_IP
    ${network_id}  ${prefix_len}  ${valid_gw}
...
Configure Less Octet IP
    # IP Address      Prefix_length  Gateway_IP
    ${less_octet_ip}  ${prefix_len}  ${valid_gw}
