...
Test Client CA Certificate
    [Documentation]  Delete client CA certificate and verify.
    [Tags]  Test_Client_CA_Certificate
    ...
    OpenBMC Delete Request  ${CLIENT_CA_CERTIFICATE_URI}
    # Adding delay after certificate deletion
    Sleep  30s
