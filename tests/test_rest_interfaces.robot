...
Verify REST Get Message JSON Compliant
    [Documentation]  Verify REST "GET" message are JSON format compliant.
...
Verify REST Post Message JSON Compliant
    [Documentation]  Verify REST "POST" message are JSON format compliant.
...
Verify REST Put Message JSON Compliant
    [Documentation]  Verify REST "PUT" message are JSON format compliant.
