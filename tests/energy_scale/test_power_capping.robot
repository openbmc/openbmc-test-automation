*** Settings ***
Documentation     Energy scale power capping test.
...
Energy Scale Power Capping Test
    [Documentation]  Run the power capping energy scale test.
    [Tags]  Energy_Scale_Power_Capping_Test
...
Check Power Settings System On Then Off
    ...
    # This test case is also known as RQM 71559.
    ...
    ${power}=  Get DCMI Power Limit
    Should Be True  ${power} == ${power_setting}
    ...  msg=Power limit setting of watts not reatined at Runtime.
...
Check Power Settings System Off Then On
    ...
    # This test case is also known as RQM 71556.
...
Change Power Limit At Runtime
    ...
    # This test case is also known as RQM 71560.
...
Disable And Enable Power At Runtime
    ...
    # This test case is also known as RQM 71561.
