...
DIMM Present And Not Present
    ...
    Read The Attribute
    ...  ${HOST_INVENTORY_URI}system/chassis/motherboard/dimm3  Present
...
DIMM Functional And Not Functional
    ...
    Read The Attribute
    ...  ${HOST_INVENTORY_URI}system/chassis/motherboard/dimm3  Functional
    Response Should Be Equal  ${0}
    Run IPMI Command
...
CPU Functional And Not Functional
    ...
    Read The Attribute
    ...  ${HOST_INVENTORY_URI}system/chassis/motherboard/cpu0  Functional
    Response Should Be Equal  ${0}
    Run IPMI Command
...
Core Present And Not Present
    ...
    Read The Attribute
    ...  ${HOST_INVENTORY_URI}system/chassis/motherboard/cpu0/core4  Present
    Response Should Be Equal  ${1}
    Run IPMI Command
...
Core Functional And Not Functional
    ...
    Read The Attribute
    ...  ${HOST_INVENTORY_URI}system/chassis/motherboard/cpu0/core4  Functional
    Response Should Be Equal  ${0}
    Run IPMI Command
...
GPU Present And Not Present
    ...
    Read The Attribute
    ...  ${HOST_INVENTORY_URI}system/chassis/motherboard/gv100card0  Present
    Response Should Be Equal  ${1}
    Run IPMI Command
...
GPU Functional And Not Functional
    ...
    Read The Attribute
    ...  ${HOST_INVENTORY_URI}system/chassis/motherboard/gv100card0  Functional
    Response Should Be Equal  ${0}
    Run IPMI Command
...
Boot Progress Sensor Unspecified Error
    ...
    Response Should Be Equal  ${OS_BOOT_OFF}
