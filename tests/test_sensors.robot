...
Verify OCC Turbo Allowed On Enable
    [Documentation]  Set and verify OCC's turbo allowed on enable.
    # The allowed value for turbo allowed:
    # True  - To diable turbo allowed.
    # False - To enable turbo allowed.

    [Tags]  Verify_OCC_Turbo_Allowed_On_Enable
...
Verify OCC Turbo Allowed On Disable
    [Documentation]  Set and verify OCC's turbo allowed on disable.
    # The allowed value for turbo allowed:
    # True  - To diable turbo allowed.
    # False - To enable turbo allowed.

    [Tags]  Verify_OCC_Turbo_Allowed_On_Disable
