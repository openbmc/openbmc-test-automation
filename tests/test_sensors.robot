...
DIMM Present And Not Present
    ...
    Run IPMI Command  0x04 0x30 0xac 0xa9 0x00 0x40 0x00 0x00 0x00 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/dimm3  Present
    Response Should Be Equal    ${1}
    Run IPMI Command  0x04 0x30 0xac 0xa9 0xff 0x00 0x00 0x40 0x00 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/dimm3  Present
    Response Should Be Equal    ${0}

DIMM Functional And Not Functional
    [Documentation]  Verify the DIMM Functional
    [Tags]  DIMM_Functional_And_Not_Functional

    Run IPMI Command  0x04 0x30 0xac 0x00 0x00 0x10 0x00 0x00 0x00 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/dimm3  Functional
    Response Should Be Equal    ${0}
    Run IPMI Command  0x04 0x30 0xac 0x00 0x00 0x00 0x00 0x10 0x00 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/dimm3  Functional
    Response Should Be Equal    ${1}
...
CPU Present And Not Present
    ...
    Run IPMI Command  0x04 0x30 0x5a 0xa9 0x00 0x80 0x00 0x00 0x00 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/cpu0  Present
    Response Should Be Equal    ${1}
    Run IPMI Command  0x04 0x30 0x5a 0xa9 0x00 0x00 0x00 0x80 0x00 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/cpu0  Present
    Response Should Be Equal    ${0}

CPU Functional And Not Functional
    [Documentation]  Verify the CPU Functional
    [Tags]  CPU_Functional_And_Not_Functional

    Run IPMI Command  0x04 0x30 0x5a 0xa9 0x00 0x00 0x00 0x80 0x00 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/cpu0  Functional
    Response Should Be Equal    ${0}
    Run IPMI Command  0x04 0x30 0x5a 0x00 0x00 0x00 0x00 0x00 0x01 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/cpu0  Functional
    Response Should Be Equal    ${1}
...
Core Present And Not Present
    ...
    Run IPMI Command  0x04 0x30 0x1e 0xa9 0x00 0x80 0x00 0x00 0x00 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/cpu0/core4  Present
    Response Should Be Equal    ${1}
    Run IPMI Command  0x04 0x30 0x1e 0x00 0x00 0x00 0x00 0x00 0x01 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/cpu0/core4  Present
    Response Should Be Equal    ${0}

Core Functional And Not Functional
    [Documentation]  Verify the Core Functional
    [Tags]  Core_Functional_And_Not_Functional

    Run IPMI Command  0x04 0x30 0x1e 0xa9 0xff 0x00 0x01 0x00 0x00 0x00 0x20 0x00
...
GPU Present And Not Present
    ...
    Run IPMI Command  0x04 0x30 0xC5 0xa9 0x00 0x80 0x00 0x00 0x00 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/gv100card0  Present
    Response Should Be Equal    ${1}
    Run IPMI Command  0x04 0x30 0xC5 0xa9 0x00 0x00 0x00 0x80 0x00 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/gv100card0  Present
    Response Should Be Equal    ${0}

GPU Functional And Not Functional
    [Documentation]  Verify the GPU Functional
    [Tags]  GPU_Functional_And_Not_Functional

    Run IPMI Command  0x04 0x30 0xC5 0xa9 0xff 0x00 0x01 0x00 0x00 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/gv100card0  Functional
    Response Should Be Equal    ${0}
    Run IPMI Command  0x04 0x30 0xC5 0x00 0x00 0x00 0x00 0x00 0x01 0x00 0x20 0x00
    Read The Attribute  ${HOST_INVENTORY_URI}system/chassis/motherboard/gv100card0  Functional
    Response Should Be Equal    ${1}
...
TPM Enable and Disable
    ...
    Run IPMI Command  0x04 0x30 0xD7 0x00 0x00 0x01 0x00 0x00 0x00 0x00 0x20 0x00
    Read The Attribute  ${CONTROL_URI}/host0/TPMEnable  TPMEnable
    Response Should Be Equal  ${0}
    Run IPMI Command  0x04 0x30 0xD7 0x00 0x00 0x02 0x00 0x00 0x00 0x00 0x20 0x00
    Read The Attribute  ${CONTROL_URI}/host0/TPMEnable  TPMEnable
    Response Should Be Equal  ${1}
...
Autoreboot Enable and Disable
    ...
    Run IPMI Command  0x04 0x30 0xDA 0x00 0x00 0x01 0x00 0x00 0x00 0x00 0x20 0x00
    Read The Attribute  ${CONTROL_URI}/host0/auto_reboot  AutoReboot
    Response Should Be Equal  ${0}
    Run IPMI Command  0x04 0x30 0xDA 0x00 0x00 0x02 0x00 0x00 0x00 0x00 0x20 0x00
    Read The Attribute  ${CONTROL_URI}/host0/TPMEnable  TPMEnable
    Response Should Be Equal  ${1}
...
OCC Active Enable And Disable
    ...
    Response Should Be Equal  ${1}
    Run IPMI Command  0x04 0x30 0x09 0x00 0x00 0x02 0x00 0x00 0x00 0x00 0x20 0x00
    Read The Attribute  ${OPENPOWER_CONTROL}/occ0  OccActive
    Response Should Be Equal  ${0}
...
OS Status Sensor Progress
    ...
    Run IPMI Command  0x04 0x30 0x05 0x00 0x00 0x04 0x00 0x00 0x00 0x00 0x20 0x00
...
Boot Progress Sensor Unspecified Error
    ...
    Run IPMI Command  0x04 0x30 0x03 0xa9 0x00 0x02 0x00 0x00 0x00 0x00 0x00 0x00
