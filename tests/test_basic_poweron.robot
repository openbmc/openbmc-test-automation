...
Verify Uptime Average Against Threshold
    ...
    ${standby_time}=  Convert Time  ${startup_time.split("= ",1)[1].strip(".")}

    Should Be True  ${standby_time} < ${startup_time_threshold}
    ...  msg=${standby_time} greater than threshold value of ${startup_time_threshold}.
