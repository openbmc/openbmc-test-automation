...
Test Firmware Version
    [Documentation]     Test case for verifying if the FW Version field is set with valid strings. \n
    ...
    Should not be empty     ${jsondata["data"]["version"]}    item, msg=version field is empty
    Should Match Regexp     ${jsondata["data"]["version"]}      ^v\\d+\.\\d+


Test Bios Version
    [Documentation]     Test case for verifying if the BIOS Version field is set with valid strings. \n
    ...     Expected in following format:
