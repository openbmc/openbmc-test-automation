...
BMC Software Version
    ...
    [Template]  Software Version Management
...
Software Version Management
    ...
    [Arguments]  ${sw_purpose}

    # Description of argument(s):
    # sw_purpose    BMC or host software purpose.
    ...
    # ]
    ${obj_list}=  Get Software Objects  ${sw_purpose}
    : FOR  ${index}  IN  @{obj_list}
    \  ${resp}=  Get Host Software Property  ${index}
    \  Verify Software Properties  ${resp}  ${sw_purpose}


Verify Software Properties
    [Documentation]  Verify the software object properties.
    [Arguments]  ${sw_property}  ${sw_purpose}

    # Description of argument(s):
    # sw_property   JSON response data.
    # sw_purpose    BMC or host software purpose.
    #        (e.g. "xyz.openbmc_project.Software.Version.VersionPurpose.BMC"
    #              "xyz.openbmc_project.Software.Version.VersionPurpose.Host").

    Check Activation Status  ${sw_property["Activation"]}
    Run Keyword If  '${sw_purpose}' == '${VERSION_PURPOSE_BMC}'
    ...  Check BMC Version  ${sw_property["Version"]}
