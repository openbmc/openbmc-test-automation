...
Network Setup
    ...
    ${ip_n_prefixes}=  Get System IP And Prefix_Length
    Set Suite Variable  ${ip_n_prefixes}
...
Validate IP Address
    ...
    Should Contain Match  ${ip_n_prefixes}  ${ip_address}*
...
Validate Prefix Length
    ...
    Should Contain Match  ${ip_n_prefixes}  */${prefix_length}
