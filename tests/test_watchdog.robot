...
Modify And Verify Watchdog TimeRemaining
    ...
    Set Watchdog Timer Attribute  ${NEW_TIMEREMAIN}  TimeRemaining
    ${resp}=  Read Attribute  ${HOST_WATCHDOG_URI}  TimeRemaining
    Should Not Be Equal As Strings  ${NEW_TIMEREMAIN}  ${resp}
...
Enable Watchdog Timer And Verify TimeRemaining
    ...
    Wait Until Keyword Succeeds  5min  90
