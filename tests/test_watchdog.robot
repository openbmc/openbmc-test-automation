...
*** Variables ***
${HOST_WATCHDOG_ATTR_URI}  ${HOST_WATCHDOG_URI}/attr/${attr}
${NEW_INTERVAL}  15000
...
Check Watchdog Timer On Host PowerOn
    ...
    ${resp}=  Read Watchdog Timer Attribute 
...
Enable Watchdog Timer And Verify TimeRemaining 
    ...
    Wait Until Keyword Succeeds  2min  5
...
Set Watchdog Timer Attribute 
    ...
    ${resp}=  OpenBMC Put Request  ${HOST_WATCHDOG_URI}/attr/${attr}  data=${valueDict}
    ${jsondata}=  to JSON  ${resp.content}

Read Watchdog Timer Attribute
    [Documentation]  Read Watchdog Timer Attribute.
