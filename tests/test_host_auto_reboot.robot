...
Put Current And Transition Host State
    ...
    # HOST_TARNS_STATE  Expected transition host state.

    ${host_trans_state}=  Get Host Trans State
    ${host_state}=  Get Host State

    ${condition}=   Catenate  SEPARATOR=
    ...  '${host_trans_state}' == '${HOST_TARNS_STATE}'${SPACE}
    ...  and '${host_state}' == '${HOST_STATE}'
    ...
    ${host_trans_state}=  Get Host Trans State
    Should Be Equal  ${host_trans_state}  ${HOST_TARNS_STATE}
