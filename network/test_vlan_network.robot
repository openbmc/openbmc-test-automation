...
Add Invalid VLAN Via REST And Verify
    ...
    Create VLAN  ${invalid_vlan_id}  expected_result=invalid
...
Delete VLAN Via REST
    ...
    Verify Existence Of VLAN  ${vlan_id}
    Delete VLAN  ${vlan_id}
    Verify Existence Of VLAN  ${vlan_id}  expected_result=non_exist
...
Delete IP On VLAN Via REST
    ...
    Get VLAN URI  ${vlan_id}  ${ip}  expected_result=non_exist
...
Create VLAN
    ...
    ...      msg=Allowing the configuration of an invalid VLAN ID.
    ...  ELSE
    ...      Should Be Equal  ${status}  ${True}
    ...      msg=Allowing the configuration of a valid VLAN ID.
...
Configure Network Settings On VLAN
    ...
    ...  ELSE
    ...      Should Be Equal  ${status}  ${True}
    ...      msg=Allowing the configuration of a valid IP.


Get VLAN URI
    [Documentation]  Get and return the URI for a VLAN IP.
    [Arguments]  ${vlan_id}  ${vlan_ip}  ${expected_result}=exist
    ...
    Run Keyword If  '${expected_result}' == 'non_exist'
    ...      Should Be Equal  ${status}  ${False}
    ...      msg=Allowing non-existence of VLAN URI.
    ...  ELSE
    ...      Should Be Equal  ${status}  ${True}
    ...      msg=Allowing existence of VLAN URI.
    ${uris}=  Get Dictionary Keys  ${vlan_record}
...
Verify Existence Of VLAN
    ...
    [Arguments]  ${id}  ${interface}=eth0  ${expected_result}=exist
    ...
    Run Keyword If  '${expected_result}' == 'non_exist'
    ...      Run Keywords  Should Be Equal  ${cli_status}  ${False}
    ...      msg=Verifying non-existence of VLAN ID.  AND
    ...      Should Be Equal  ${rest_status}  ${False}
    ...      msg=Verifying non-existence of VLAN ID.
    ...  ELSE
    ...      Run Keywords  Should Be Equal  ${cli_status}  ${True}
    ...      msg=Verifying non-existence of VLAN ID.  AND
