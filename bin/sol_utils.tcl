...
longoptions openbmc_host: openbmc_username:=root openbmc_password:=0penBmc\
  os_host: os_username:=root os_password: proc_name: ftp_username:=0 \
  ftp_password:=0 os_repo_url:=0 test_mode:=0 quiet:=0 debug:=0
pos_parms
...
proc install_os {} {
  ...
  set dns [get_host_dns $os_host $os_username $os_password 0]
