...
Create Error On BMC And Verify If Trap Is Sent
    ...
    Delete SNMP Manager And Object  ${SNMP_MGR1_IP}  ${SNMP_DEFAULT_PORT}
    SSHLibrary.Execute Command  sudo killall snmptrapd
    ${lines}=  Get Lines Containing String  ${SNMP_LISTEN_OUT}  SNMPv2-
    ${SNMP_TRAP} =  Split String  ${lines}  \t

    Should Be Equal  ${SNMP_TRAP}[0]  SNMPv2-MIB::snmpTrapOID.0 = OID: SNMPv2-SMI::enterprises.49871.1.0.0.1
    Should Match Regexp  ${SNMP_TRAP}[1]  SNMPv2-SMI::enterprises.49871.1.0.1.1 = Gauge32: \[0-9]*
    Should Match Regexp  ${SNMP_TRAP}[2]  SNMPv2-SMI::enterprises.49871.1.0.1.2 = Opaque: UInt64: \[0-9]*
    Should Match Regexp  ${SNMP_TRAP}[3]  SNMPv2-SMI::enterprises.49871.1.0.1.3 = INTEGER: \[0-9]
    Should Be Equal  ${SNMP_TRAP}[4]  SNMPv2-SMI::enterprises.49871.1.0.1.4 = STRING: "${expected_error}"
