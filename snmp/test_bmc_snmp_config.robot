...
Configure BMC SNMP Manager With Invalid IP And Verify
     [Documentation]  Configure SNMP manager on BMC with invalid IP and verify.
     [Tags]  Configure_BMC_SNMP_Manager_With_Invalid_IP_And_Verify
     [Template]  Configure SNMP Manager On BMC
