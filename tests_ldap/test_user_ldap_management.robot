...
Verify LDAP Client Service Is Running And API Available
    ...
    ${resp}=  Read Properties  ${LDAP_SERVER_URI}
...
Verify LDAP Secure Mode Is Set
    ...
    Write Attribute  ${LDAP_SERVER_URI}/config/attr/LDAPType  data=${ldap_mode}
...
Verify LDAP Server URI Is Set
    ...
    Write Attribute  ${LDAP_SERVER_URI}/config/attr/LDAPServerURI  data=${ldap_server}
...
Verify LDAP Server BIND DN Is Set
    ...
    Write Attribute  ${LDAP_SERVER_URI}/config/attr/LDAPBindDN  data=${ldap_server_binddn}
...
Verify LDAP Server BASE DN Is Set
    ...
    Write Attribute  ${LDAP_SERVER_URI}/config/attr/LDAPBaseDN  data=${ldap_server_basedn}
...
Delete LDAP Config
    ...
    ${resp}=  OpenBMC Post Request
    ...  ${LDAP_SERVER_URI}/action/delete  data=${data}
