*** Settings ***
Documentation    Remote logging testing for rsyslog.

Resource         ../lib/resource.txt
Resource         ../lib/rest_client.robot
Resourece        ../lib/utils.robot
...
Configure Remote Logging Server
    ...
    Should Be Equal As String  ${data[Address]}  ${REMOTE_LOGGING_SERVER_HOST}
    Should Be Equal As String  ${data[Port]}  ${REMOTE_LOGGING_SERVER_PORT}
