...
# REMOTE_USERNAME           The remote logging server login userid.
# REMOTE_PASSWORD           The password for the remote logging server login.
...
Verfiy BMC Journald Synced To Remote Logging Server
    ...
    ...  msg=${bmc_journald} and ${remote_journald} doesn't match.
