...
Test Get BIOS POST Code via IPMI Raw Command
    ...
    [Tags]  Test Get_BIOS_POST_Code_via_IPMI_Raw_Command
...
Test Get BIOS POST Code via IPMI Raw Command After Power Cycle
    ...
    [Tags]  Test Get_BIOS_POST_Code_via_IPMI_Raw_Command_After_Power_Cycle
...
Test Get BIOS POST Code via IPMI Raw Command With Host Powered Off
    ...
    [Tags]  Test Get_BIOS_POST_Code_via_IPMI_Raw_Command_With_Host_Powered_Off
