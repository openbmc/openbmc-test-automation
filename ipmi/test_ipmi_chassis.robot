...
Verify BMC Boot Flag With Invalid Invalid Data Length
    [Documentation]  Verify BMC Boot Flag With Invalid Data Length.
    [Tags]  Verify_BMC_Boot_Flag_With_Invalid_Invalid_Data_Length
    [Template]  Verify Invalid IPMI Command
    [Teardown]  FFDC On Test Case Fail

    # Invalid data                                                                         Expected error code
    ${IPMI_RAW_CMD['system_boot_options']['Get_Boot_Flag_Valid_Bit_Clearing'][1]}                  0xc7
    ${IPMI_RAW_CMD['system_boot_options']['Set_Boot_Flag_Valid_Bit_Clearing'][1]}                  0xc7
...
Set BMC Boot Flag Valid Bit Clearing Via IPMI
    ...
    ${ipmi_cmd}=  Catenate  ${IPMI_RAW_CMD['system_boot_options']['Set_Boot_Flag_Valid_Bit_Clearing'][0]}  ${flag_valid_bit}
