...
Verify Get Channel Info via IPMI
    ...
    ${channel_medium_type}=  Get Channel Medium Type Mapping Table  ${channel_info_ipmi['channel_0x${CHANNEL_NUMBER}_info']['channel_medium_type']}
    ${channel_protocol_type}=  Get Channel Protocol Type Mapping Table  ${channel_info_ipmi['channel_0x${CHANNEL_NUMBER}_info']['channel_protocol_type']}

    ${alerting}=  Get Disabled Mapping Table  ${channel_info_ipmi['channel_0x${CHANNEL_NUMBER}_info']['alerting']}
    ${per-message_auth}=  Get Disabled Mapping Table  ${channel_info_ipmi['channel_0x${CHANNEL_NUMBER}_info']['per-message_auth']}
    ${user_level_auth}=  Get Disabled Mapping Table  ${channel_info_ipmi['channel_0x${CHANNEL_NUMBER}_info']['user_level_auth']}
    ${access_mode}=  Get Channel Access Mode Mapping Table  ${channel_info_ipmi['channel_0x${CHANNEL_NUMBER}_info']['access_mode']}

    Valid Value  channel_medium_type  ['${active_channel_config['${CHANNEL_NUMBER}']['channel_info']['medium_type']}']
    Valid Value  channel_protocol_type  ['${active_channel_config['${CHANNEL_NUMBER}']['channel_info']['protocol_type']}']
