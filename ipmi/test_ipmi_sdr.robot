...
Get Reserve Device SDR Repository
    ...
    # Get Reserve Device SDR Repository command via inband IPMI.
...
Get Record Count And Last Record From SDR
    ...
    # Then last record ID will be 57 (decimal) - then hexadecimal will be 39h.
...
Suite Setup Execution
    [Documentation]  Do the initial suite setup to fetch
    ...  available uris from the base uri.
