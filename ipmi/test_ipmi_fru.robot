...
Verify IPMI and Redfish subcomponents
    ...
    [Arguments]  ${redfish_power_supply_reading}  ${ipmi_fru_component_info}
    
    # Description of argument(s):
    # ${ipmi_fru_component_info}  IPMI FRU component  values
    # ${redfish_power_supply_reading}  Redfish FRU component values

    ${sub_component_count}=  Get Length  ${redfish_power_supply_reading}
    ...
    FOR  ${sub_component_index}  IN RANGE  0  ${sub_component_count}
      ...
      ...  Get From List  ${ipmi_fru_component_info}  ${sub_component_index}
      ${redfish_fru_sub_component}=
      ...  Get From List  ${redfish_power_supply_reading}  ${sub_component_index}
