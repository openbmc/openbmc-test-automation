...
Test Create VLAN Via IPMI
    ...
    [Teardown]  Run Keywords  FFDC On Test Case Fail  AND   Set VLAN Id Off Via IPMI  AND  Restore Configuration
...
Set VLAN Id Off Via IPMI
    Run Inband IPMI Standard Command
    ...  lan set ${CHANNEL_NUMBER} vlan id off  login_host=${0}
