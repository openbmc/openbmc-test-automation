...
Test IPMI User Privilege
    ...
    Verify IPMI Command  ${random_username}  ${valid_password}  User  expected_status=${user_cmd_status}
    Verify IPMI Command  ${random_username}  ${valid_password}  Operator  expected_status=${operator_cmd_status}
    Verify IPMI Command  ${random_username}  ${valid_password}  Administrator  expected_status=${admin_cmd_status}
