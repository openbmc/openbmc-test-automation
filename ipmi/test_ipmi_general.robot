...
Test Get Self Test Results via IPMI Raw Command
    ...
    Should Contain Any  ${resp_bytes}[0]  55  57
...
Verify Channel Auth Capabilities
    ...
    ${is_channel_valid}=  Verify If Channel Exists Via IPMI  ${channel}
...
Verify Channel Auth Capabilities For Invalid Channel
    ...
    # See if channel is valid.
    ${is_channel_valid}=  Verify If Channel Exists Via IPMI  ${channel_in_hex}
    IF  not ${is_channel_valid}
