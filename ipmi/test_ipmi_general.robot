...
Verify Get Channel Authentication Capablities IPMI Raw Command With Invalid Data Length
    ...
    [Template]  Verify Channel Authentication Command For Invalid Data Length
...
Verify Channel Auth Capabilites For Invalid Channel
    ...
    # Description of arguments
    # ${channel}   intreface channel number
...
Verify Channel Authentication Command For Invalid Data Length
