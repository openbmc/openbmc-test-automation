...
Test Get Channel Authentication Capabilities IPMI cmd For Invalid Channel
    [Documentation]  verify get channel authentication capabilities for invalid channel.
    [Tags]  Test_Get_Channel_Authentication_Capabilities_IPMI_Cmd_For_Invalid_Channel
...
Verify Get Channel Authentication Capablities IPMI Raw Command With Invalid Request Data Length
    [Documentation]  Verify get channel authentication capablities IPMI raw command with invalid data length request.
    [Tags]  Verify_Get_Channel_Authentication_Capablities_IPMI_Raw_Command_With_Invalid_Request_Data_Length
    [Template]  Verify Channel Authentication Command For Invalid Request Data Length
...
Verify Channel Auth capabilities
    [Documentation]  Verify Channel Auth Capabilites for given channel and privilege.
...
Verify Channel Authentication Command For Invalid Request Data Length
   [Documentation]  Verify Channel Authentication Command for Invalid request data Length.
