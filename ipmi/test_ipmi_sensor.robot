...
Test Baseboard Temperature Via IPMI
    ...
    ${lines}=  Split To Lines  ${baseboard_temp_line}
    ${baseboard_temp_ipmi}=  Set Variable  ${lines[0].split('+')[1].strip(' C')}
    ...
    ${baseboard_temp_diff}=  Evaluate  abs(${baseboard_temp_redfish["PCIE_0_Temp"]} - ${baseboard_temp_ipmi})
    Should Be True
