...
Enable Present Bit Via IPMI and Verify Using Redfish
    ...
    ${sensor_dict}=  Get IPMI Sensor ID Dict  ${component}

    FOR    ${sensor_id}    IN    @{sensor_dict}
        ${sensor_name}=  Get From Dictionary  ${sensor_dict}  ${sensor_id}
        ...
        ${sensor_properties}=  Redfish.Get Properties  /redfish/v1/Systems/system/Processors/${oedfish_component}
...
Get Sensor Id For Sensor Name
    ...
    # e.g.: output for ${id_value} is 0x42.
...
Get IPMI Sensor ID Dict
    ...
    # e.g.: output for ${sensor_dict}
    # {'dcm0_cpu0': '0x41', 'dcm0_cpu1': '0x42', 'dcm1_cpu0': '0x43',
