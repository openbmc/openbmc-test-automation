...
Get Default DCMI Configuration Parameters For Param 2
    ...
    [Tags]  Get_Default_DCMI_Configuration_Parameter_For_Param_2
...
Check Error Completion Code For Discovery Method With Random Backoff
    [Documentation]  Check error completion code for param 2 discovery method with random backoff
    [Tags]  Check_Error_Completion_Code_For_Discovery_Method_With_Random_Backoff
