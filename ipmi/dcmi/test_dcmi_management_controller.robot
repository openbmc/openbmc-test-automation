...
Set And Get Management Controller Identifier String
    ...
    Run Keyword And Continue On Failure  Lists Should Be Equal  ${ipmi_cmd_rsp_list[2:]}  ${set_dcmi_mcid_cmd}
    ...
    Run Keyword And Continue On Failure  Lists Should Be Equal  ${ipmi_cmd_rsp_list[2:]}  ${bytes_list}
