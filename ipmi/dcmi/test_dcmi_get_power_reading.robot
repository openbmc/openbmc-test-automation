*** Settings ***
Documentation    Module to test dcmi get power reading functionality.
...
Verify DCMI Get Power Reading With Invalid Data Field In Request
    [Documentation]  Verify IPMI DCMI raw command with invalid data field in request
    ...  and expect the error code.
...
Get Content From Json File
    ...
    ${ret}=  Convert String To JSON  ${json_file_resp[0]}
...
Get Dbus Object From Json File
    ...
    ${ret}=  Get Content From Json File  ${json_file}
