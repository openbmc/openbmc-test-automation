...
Verify System Info Set In Progress
    ...
    # ${resp[0]} - parameter version.
    # ${resp[1]} - Configuration parameter data,
...
Verify System Info System Firmware Version
    ...
    # ${resp}= "11 00 00 0e 7a 77 63 6c 4d 58 77 66 63 7a 4d 76".
    ${resp}=  Split String  ${resp}
...
Verify System Info Primary OS Name
    ...
    # The response data will something be like,
    # ${resp}= "11 00 00 0e 56 65 72 73 69 6f 6e 32 2e 31 32 33".
    ${resp}=  Split String  ${resp}
...
Identify Request Data
    ...
    ${resp_data}=  Split List With Index  ${string}  1
    # ${resp_data} will be ['z', 'w', 'c'].
...
Suite Setup Execution
    ...
    ...  prefix each bytes with 0x and make them a suite variable.
