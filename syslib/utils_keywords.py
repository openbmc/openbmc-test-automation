...
###############################################################################
def build_error_list(error_str):

    r"""
    Convert error string entries into error list.

    Description of argument(s):
    error_str        Error entry string.
    ...
    Error Text:cudaEventSynchronize for stopEvent returned err = 0039 from file , line 430.
    ---------------------------------------------------------------------
    ---------------------------------------------------------------------
    Device id:/dev/nvidia0
    Timestamp:Mar 29 19:41:54 2017
    ...
    for line in error_str.splitlines():
        ...
        if line.startswith("-") and parse_walk == False:
            parse_walk = True
            continue
