...
##########################################################################
def inv_check_if_can_ignore_item(category, item, I_FILE_IGNORE_DICT):
    r"""
                ...
                for myline in diff:
                    ...
                    if ((diffitem.startswith('- ')) or (diffitem.startswith('+ '))
                        ...
                        if ((diffitem.startswith('- '))
                            ...
                            if inv_check_if_can_ignore_item(
                                    category, diffitem, I_FILE_IGNORE_DICT):
                                linetoprint = "  " + \
                                    str(the_row) + " " + diffitem + \
                                    "    +++ NOTE! This is an ignore item. " + \
                                    " See I_FILE_IGNORE_DICT" + \
                                    " in module utils_variables.py +++\n"
                            else:
