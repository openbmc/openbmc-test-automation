        ...
        if ((len(initial) > min_json_byte_size) and (initial == final)):
            ...
            try:
                ...
                for myline in diff:
                    ...
                    # if its a category, such as *processor or *memory, save it
                    # we will print it out later
                    for hh in I_CATS:
                        if (hh in diffitem):
                            category = hh
                    ...
                    if ((diffitem.startswith('- ')) or (diffitem.startswith('+ '))
                        ...
                        if ((diffitem.startswith('- '))
                            ...
                            if skip_inventory_item(category, diffitem):
                                ...
                                # have an item not on the ignore list.  The flag 
                                # will determine the # return code we pass back to 
                                # the user at the end
