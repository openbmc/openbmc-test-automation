...
# whenever a comparison between inventory files is done.
# For example, assigned processor speed routinely varies depending upon the needs
# of OCC/tmgt/ondemand govenor.   Back-to-back inventory runs will show processor
...
I_FILE_IGNORE_DICT = {'processor': 'size'}
