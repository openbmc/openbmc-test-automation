...
...                defined for system test use cases.
...
Create JSON Inventory File
    ...
    [Arguments]    ${save_inventory_to_this_file}
    ${json_file_path}=   Set Variable    ${save_inventory_to_this_file}
    Set Global Variable        ${json_file_path}
    Login To OS
