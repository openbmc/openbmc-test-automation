...
Verify Get PLDM Types
    ...
    ${pldm_output}=  Get PLDM Output  ${PLDM_GET_PLDM_TYPES_CMD}
...
Verify Get PLDM Version For Base Type
    ...
    ${pldm_output}=  Get PLDM Output  ${PLDM_GET_PLDM_VERSION_BASE_CMD}
...
Verify Get PLDM Version For Platform Type
    ...
    ${pldm_output}=  Get PLDM Output  ${PLDM_GET_PLDM_VERSION_PLATFORM_CMD}
...
Verify Get PLDM Version For BIOS Type
    ...
    ${pldm_output}=  Get PLDM Output  ${PLDM_GET_PLDM_VERSION_BIOS_CMD}
...
Verify Get PLDM Version For FRU Type
    ...
    ${pldm_output}=  Get PLDM Output  ${PLDM_GET_PLDM_VERSION_FRU_CMD}
