...
Set Static Host Network Address Via IPMI
    ...
    ${new_ip_address}=
    ...  Read Attribute  ${XYZ_NETWORK_MANAGER}host0/intf/addr  Address
    ${new_gateway_ip}=
    ...  Read Attribute  ${XYZ_NETWORK_MANAGER}host0/intf/addr  Gateway
    ${new_prefix_length}=  Read Attribute
    ...
    Should Be Equal  ${new_ip_address}  ${ip_address}
    Should Be Equal  ${new_gateway_ip}  ${gateway_ip}
    Should Be Equal  ${new_prefix_length}  ${prefix_length}
