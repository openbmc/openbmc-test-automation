...
${valid_mac}         AA:AA:AA:AA:AA:AA
${broadcast_mac}     FF:FF:FF:FF:FF:FF
${out_of_range_mac}  FF:FF:FF:FF:FF:100
...
Revert To Initial MAC
    [Documentation]  Revert to initial MAC address.
    [Tags]  Revert_To_Initial_MAC
...
Validate MAC on BMC
    ...
    ${system_mac}=  Get MAC Address Of BMC
...
Configure MAC Settings
    ...
    ...  OpenBMC Put Request  ${XYZ_NETWORK_MANAGER}/eth0/attr/MACAddress  data=${data}
...
Get MAC Address Of BMC
    ...
    # Sample output of "ifconfig | grep HWaddr":
    # eth0      Link encap:Ethernet  HWaddr xx:xx:xx:xx:xx:xx

    ${cmd_output}=  Execute Command On BMC  /sbin/ifconfig | grep HWaddr
