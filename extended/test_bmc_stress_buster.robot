...
Stress BMC REST Server
    [Documentation]  Execute maximum allowed REST operation and expect success.
    ...
    ...  msg=One or more REST operation has failed.


Stress BMC SSH Server
    [Documentation]  Execute maximum allowed SSH operation and expect success.
    [Tags]  Stress_BMC_SSH_Server
    ${dict}=  Execute Process
    ...  ${SSH_BUSTER_MAX}  SSH Connect And Execute Command
    Dictionary Should Not Contain Value  ${dict}  False
    ...  msg=One or more SSH operation has failed.


Stress BMC IPMI Server
    [Documentation]  Execute maximum allowed IPMI operation and expect success.
    [Tags]  Stress_BMC_IPMI_Server
    ${dict}=  Execute Process  ${IPMI_BUSTER_MAX}  IPMI Check Status
    Dictionary Should Not Contain Value  ${dict}  False
    ...  msg=One or more IPMI operation has failed.
