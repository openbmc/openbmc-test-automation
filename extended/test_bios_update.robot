*** Settings ***
Documentation     Updates the PNOR image on the host for
...
Host BIOS Update And Boot
    [Tags]    open-power
    [Documentation]   Update PNOR image on the host (BIOS), and
...
Prepare BMC For Update
    [Documentation]  Ready system for PNOR update.
