...
Verify NXDMAENGFIR RE With TH Limit 1
    ...
    Inject Recoverable Error With Thershold Limit Through Host
    ...  ${value[0]}  ${value[1]}  1  ${DES_NX_RECV1}  ${err_log_path}
...
Verify NXDMAENGFIR RE With TH Limit 32
    ...
    Inject Recoverable Error With Thershold Limit Through Host
    ...  ${value[0]}  ${value[1]}  32  ${DES_NX_RECV32}  ${err_log_path}
...
Verify CXAFIR RE With TH Limit 5
    ...
    Inject Recoverable Error With Thershold Limit Through Host
    ...  ${value[0]}   ${value[1]}  5  ${DES_CXA_RECV5}  ${err_log_path}
...
Verify CXAFIR RE With TH Limit 32
    ...
    Inject Recoverable Error With Thershold Limit Through Host
    ...  ${value[0]}  ${value[1]}  32  ${DES_CXA_RECV32}  ${err_log_path}
...
Verify NPU0FIR RE With TH Limit 32
    [Documentation]  Verify NPU0FIR RE With TH Limit 32 through HOST.
    [Tags]  Inject_NPU0FIR_RE_With_TH_Limit_32

    ${value}=  Get From Dictionary  ${Test_array}  NPU0_RECV32
    ${err_log_path}=  Catenate  ${RAS_LOG_PATH}npu0fir_th32
    Inject Recoverable Error With Thershold Limit Through Host
    ...  ${value[0]}  ${value[1]}  32  ${DES_NPU0_RECV32}  ${err_log_path}
