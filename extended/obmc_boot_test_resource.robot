...
# The path to the boot_table.json file which defines the boot requirements.  This defaults to the value of the BOOT_TABLE_PATH environment variable or to data/boot_table.json.
