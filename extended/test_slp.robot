...
# SLP_SEVICES  Services listed by slptool, by default Empty.
${SLP_SEVICES}       ${EMPTY}
...
Verify Service Agents For Service Types
    ...
    @{parameters}=  Split String  ${SLP_SEVICES}  ${\n}
...
Get Service Types
    ...
    ${SLP_SEVICES}=  Run SLP command  ${service_types}
    Set Suite Variable  ${SLP_SEVICES}
...
Verify Service Types
    ...
    ${remove_prefix}=  Remove String  ${SLP_SEVICES}  service:
