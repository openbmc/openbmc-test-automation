...
${CMD_OUTPUT}       ${EMPTY}
# CMD_OUTPUT- Services listed by slptool, by default Empty.

*** Test Cases ***

Find And Verify Service Types
...
Verify Service Types
    ...
    ${remove_prefix}=  Remove String  ${CMD_OUTPUT}  service:
