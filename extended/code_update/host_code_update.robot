...
Test Boot With No Cache
    ...
    ...  booted the OS in the tests above, now remove the cache
    ...  VPD files and verify OS can still boot.
    ...
    # Power off.  The next test case will power-on with the new VPD files.
    REST Power Off
