...
REST PNOR Code Update
    [Documentation]  Do a PNOR code update by downloading image via REST.
    ...
    ${activation_state}=  Get Activation State  ${version_id}
    ...
    ${requested_state}=  Get Requested Activation State  ${version_id}
