...
Initiate Code Update With REST Image Upload
    [Documentation]  Start a code update by downloading image via REST
    [Tags]  Initiate_Code_Update_With_REST_Image_Upload
