...
Delete Logs And Fatally Fail
    [Documentation]  Delete dummy error logs and dumps and fail fatally,
    ...              stopping test execution

    ${error_log_paths}=  Read Properties  ${BMC_LOGGING_URI}/list
    Delete Error Log Entry  @{error_log_paths}[-1]
    Delete BMC Dump  ${dump_id}
    Fatal Error  msg=Code update failed.
...
REST BMC Code Update Teardown
    ...
    Run Keyword If Test Failed  Delete Logs And Fatally Fail
