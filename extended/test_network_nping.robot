...
Validate Setup
    ...
    Set Suite variable  ${host_packet_loss}  ${packet_loss}
    Log To Console  ${host_packet_loss}
...
Find Issue
    [Documentation]  Compare packet loss on host and BMC host.
    [Arguments]  ${bmc_loss}  ${host_loss}

    # Description of arguments:
    # ${bmc_loss}- Packet loss on BMC.
    # ${host_loss}- Packet loss on OS host.
