...
Check Test Host Server Packet Loss
    ...
    Run Keyword If
    ...  '${bmc_loss}' <= '${host_loss}'
    ...  Log To Console  \n\n*** No issue with BMC, issue with network ***\n
    ...  ELSE  Fail  msg=Failed, There is an issue with BMC.
