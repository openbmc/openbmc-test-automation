...
Verify Channel Checkstop Through OS Without Auto Reboot

    [Documentation]  Verify Channel Checkstop (MBS FIR REG INT PROTOCOL ERROR)
    ...              through OS With Auto Reboot settings disabled.
    [Tags]           Verify_Channel_Checkstop_Through_OS_Without_Auto_Reboot

    Verify Checkstop Insertion Without Auto Reboot
    ...  Centaur  2011400  4000000000000000
