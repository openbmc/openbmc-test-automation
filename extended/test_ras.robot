...
Verify Host Quiesce On Host Booted System With Auto Reboot Disabled
    [Documentation]  Verify host quiesce state after host watchdog error on
    ...  host booted system with auto reboot disabled.
    [Tags]  Verify_Host_Quiesce_On_Host_Booted_System_With_Auto_Reboot_Disabled
