...
*** Test Cases ***
Verify Openbmctool Logging Operations
    [Documentation]  Verify remote logging.
    [Tags]  Verify_Openbmctool_Logging_Operations
...
Verify Logging
    ...
    # TODO: save original logging parameters, if any,  and put them
    ...
    ...  logging remote_logging_config -a ${OPENBMC_HOST} -p 514
    Should Contain  ${result}  OK
    ...  msg=Openbmctool 'remote_logging config' returned unexpected result.

    ${rc}  ${logging_status}=  Openbmctool Execute Command
    ...  logging remote_logging view
    Should Contain  ${logging_status}  ${OPENBMC_HOST}
    ...  msg=Openbmctool 'remote_logging view' should contain ${OPENBMC_HOST}.
    ...
    Should Contain  ${logging_status}  Address
    ...  msg=Openbmctool 'remote_logging view' returned unexpected result.
    Should Not Contain  ${logging_status}  ${OPENBMC_HOST}
    ...  msg=Openbmctool 'remote_logging view' contains ${OPENBMC_HOST}.
...
Suite Setup Execution
    [Documentation]  Verify connectivity to run opbmctool commands.
