...
Write New JSON List
  ...
  [Arguments]       ${json_file_path}  ${name}
  # Description of argument(s):
  # json_file_path  Name of file to write to.
  # name            Name to give json list element.
  Append to File  ${json_file_path}  { "${name}" : [
...
Retrieve HW Info And Write List
  ...
  [Arguments]       ${list}  ${json_file_path}  ${parent}  ${last}=false
  # Description of argument(s):
  # list            The list of devices classes to retrieve with lshw.
  # json_file_path  Path of file to write to.
  # parent          Name of the JSON element to encapsulate this list.
  # last            Is this the last element in the parent JSON?
  Write New JSON List  ${json_file_path}  ${parent}
  : FOR  ${class}  IN  @{list}
...
Verify JSON String
  ...
  # Description of argument(s):
  # unverified      JSON String we will be checking for lshw comma errors.
...
Clean Up String
  ...
  [Arguments]       ${dirty}
  # Description of argument(s):
  # dirty           String that will be space stripped and have comma removed.
