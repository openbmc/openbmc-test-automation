...
#   (e.g [500,800]). See default rangess below.
...
*** Variables ***
# Default Ranges.
${FAN_RANGE_IDLE}           [3000,4000]
${FAN_RANGE_STRESS}         [3000,5000]
${TEMPRATURE_RANGE_IDLE}    [35,50]
${TEMPRATURE_RANGE_STRESS}  [50,100]
${POWER_RANGE_IDLE}         [15,40]
${POWER_RANGE_STRESS}       [40,70]
...
Verify Fan Speeds During Idle State
    ...
    Verify Fan Speeds  ${FAN_RANGE_IDLE}
...
Verify Temperature During Idle State
    ...
    Verify Temperature Values  ${TEMPRATURE_RANGE_IDLE}
...
Test Hardware Limits During Stress
    ...
    ...  Verify Fan Speeds  ${FAN_RANGE_STRESS}
    ...  AND  Verify Temperature Values  ${TEMPRATURE_RANGE_STRESS}
...
Verify Fan Speeds
    ...
    Verify Hardware Limit Range
    ...  ${max_fan_speed}  ${required_range}  fan
    Verify Hardware Limit Range
    ...  ${min_fan_speed}  ${required_range}  fan
...
Verify Temperature Values
    ...
    Verify Hardware Limit Range
    ...  ${gpu_max}  ${required_range}  temperature
    Verify Hardware Limit Range
    ...  ${gpu_min}  ${required_range}  temperature
    # Verify for CPUs.
    ${cpu_highest_temp}=  Get CPU Highest Temperature
    ${cpu_lowest_temp}=  Get CPU Lowest Temperature
    Verify Hardware Limit Range
    ...  ${cpu_highest_temp}  ${required_range}  temperature
    Verify Hardware Limit Range
    ...  ${cpu_lowest_temp}  ${required_range}  temperature
...
Verify Power Values
    ...
    Verify Hardware Limit Range  ${p0_value}  ${required_range}  power
    Verify Hardware Limit Range  ${p1_value}  ${required_range}  power