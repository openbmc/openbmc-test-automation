...
Network Stability Test
    [Documentation]  Network stabilty test.
...
BMC Network Payload
    [Documentation]  Start creating activity over BMC netowrk.
    # TBD: openbmc/openbmc-test-automation#607
    # Logic to generate network traffic
    Log To Console   \n DO NOTHING
...
Start HTX Exerciser
    ...
    ${status}=  Run Until Keywords Fails  ${HTX_DURATION}  ${HTX_INTERVAL}
    ...  Start Network Test

    Run Keyword If  '${status}' == '{False}'
    ...  Fail  Network unstable, please check for errors.
