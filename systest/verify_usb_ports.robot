...
#   DEVICE_NAME                 The USB device to be used in test.
...
Test Device
    ...
    ...  ${WAIT_TIME}  10s  Exercise USB Device
...
Write To USB Device
    ...
    ${stdout}  ${stderr}  ${rc}=  OS Execute Command
    ...  mount -rw /dev/${DEVICE_NAME} /mount-dev/
    ${stdout}  ${stderr}  ${rc}=  OS Execute Command
...
Exercise USB Device
    ...
    ${stdout}  ${stderr}  ${rc}=  OS Execute Command
    ...  htxcmdline -status | grep ${DEVICE_NAME} | awk '{print $5}'
