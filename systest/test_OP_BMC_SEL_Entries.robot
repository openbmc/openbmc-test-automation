*** Settings ***
Documentation  The goal of this test case is to test to see if SEL records are being posted to the system and that tar file containing SEL parsing tool is working correctly.
...
${ESEL_DATA} =     .*Platform Event Log - .*x.*
...
OP BMC SEL Entries    
    ...
    ${matches} =    Get Regexp Matches   ${output}     ${ESEL_DATA}   
