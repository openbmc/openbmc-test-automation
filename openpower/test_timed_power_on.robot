...
...             read the system timer and add the user timer for it
...             set the timer using busctl set-property command
...             check the system gets powered ON for the set time
...
Test Setup      Run Keywords  Redfish.Login  AND  Test Setup Execution
Test Teardown   Run Keywords  Redfish.Logout  AND  Test Teardown Execution
