...
Violate Secure Boot Using Corrupt Image
    ...
    # seen on SOL console
    # We won't see any ESEL's for HBB | HBD | HBI | BOOTKERNEL because
    # Hostboot has no mechanism to send a eSEL when it is dying
    ...
    # HBB | HBD | HBI corruption will never get far enough to log into PNOR.
