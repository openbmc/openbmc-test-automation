...
Create Admin Redfish User And Verify Login Via IPMI
    ...
    Enable IPMI Access To User From Redfish  ${random_username}
...
Update User Password Via Redfish And Verify Using IPMI
    ...
    ${payload}=  Create Dictionary  Password=${valid_password3}
    ...
    Verify IPMI Username And Password  ${random_username}  ${valid_password3}
...
Enable IPMI Access To User From Redfish
    ...
    Redfish.Patch  /redfish/v1/AccountService/Accounts/${user_name}  body=&{payload}
