...
Verify PEL Log Details
    ...
    Valid Value  pel_records['${id}']['CreatorID']  ['BMC']
    Valid Value  pel_records['${id}']['CompID']  ['0x1000']
    Valid Value  pel_records['${id}']['Subsystem']  ['BMC Firmware']
    Valid Value  pel_records['${id}']['Message']  ['An application had an internal failure']
    Valid Value  pel_records['${id}']['SRC']  ['BD8D1002']
    ...
    Valid Value  pel_records['${id}']['Sev']  ['Unrecoverable Error']
