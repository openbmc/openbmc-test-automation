...
@{mandatory_Predictive_pel_fileds}   Private Header  User Header  Primary SRC  Extended User Header  Failing MTMS  User Data
...
Verify Predictive Error Format
    [Documentation]  Verify Predictive Error Format
    [Tags]  Verify_Predictive_Error_Format
    BMC Execute Command  ${CMD_PREDICTIVE_ERROR}
