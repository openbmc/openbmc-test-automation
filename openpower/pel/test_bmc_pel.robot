...
Error Logging Rotation Policy
    ...
    ...  '${error_log_type}' == 'Unreco_Pred'  Create List  ${CMD_UNRECOVERABLE_ERROR}  ${CMD_PREDICTIVE_ERROR}
    ...  '${Info_Unreco_Pred}' == 'Unreco_Pred'  Create List  ${CMD_INFORMATIONAL_ERROR}  ${CMD_UNRECOVERABLE_ERROR}  ${CMD_PREDICTIVE_ERROR}
