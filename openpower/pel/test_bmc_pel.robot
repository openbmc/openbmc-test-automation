...
Verify FRU Callout
    ...
    Should Be Equal  ${pel_callout_section['Callout Count']}  1
    Should Be Equal As Strings  ${pel_callout_section['Callouts'][0]['FRU Type']}  Maintenance Procedure Required
    ...
    Should Be Equal As Strings  ${pel_callout_inventory_path}  /xyz/openbmc_project/inventory/system/chassis/motherboard
...
Verify Procedure And Symbolic FRU Callout
    ...
    Should Be Equal  ${pel_callout_section['Callout Count']}  2
    ...
    Should Be Equal As Strings  ${pel_callout_section['Callouts'][1]['FRU Type']}  Symbolic FRU
