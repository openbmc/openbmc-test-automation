...
Verify Older Logs Are Deleted When Count Crosses Max
    ...
    [Tags]  Verify_Older_Logs_Are_Deleted_When_Count_Crosses_Max
    ...
    # Now create 3001st log to cross thresold and start trigger error logs rotation.
    BMC Execute Command  ${CMD_PREDICTIVE_ERROR}
    # Wait few seconds for log error logs rotation to complete.
    Sleep  10s
