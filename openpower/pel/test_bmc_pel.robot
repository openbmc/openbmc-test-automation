...
Verify Error Logging Rotation Policy With Non BMC Error Logs
    [Documentation]  Verify error logging rotation policy with non-BMC error logs.
    [Tags]  Verify_Error_Logging_Rotation_Policy_With_Non_BMC_Error_Logs 
