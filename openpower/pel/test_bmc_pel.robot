...
Test Error Logging Rotation Policy
    [Documentation]  Verify that when maximum log limit is reached, error logs are deleted
    ...  to reach their max allocated space.
    ...
    #                                     log type when maximum log limit is reached.
