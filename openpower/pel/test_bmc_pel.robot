...
Verify Error Logging Rotation Policy
    ...
    [Setup]  Run Keywords  Open Connection for SCP  AND  scp.Put File  ${UNRECOVERABLE_FILE_PATH}  /tmp/FILE_NBMC_UNRECOVERABLE
    ...
    Unrecoverable NON_BMC 1500, Predictive BMC 1500                              60
    Unrecoverable NON_BMC 1500, Unrecoverable BMC 1500                           60
