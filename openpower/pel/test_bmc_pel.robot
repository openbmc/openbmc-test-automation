...
Verify Error Logging Rotation Policy
    ...
    Info_Unreco            bmc                      45
    Info_Predict           bmc                      45
    Unreco_Predict         bmc                      30
    Info_Unreco_Pred       bmc                      45
...
FormulateCommands
     ...
     ${cmd}=  Run Keyword If
     ...  '${error_log_type}' == 'Info_Unreco' and '${system_type}' == 'bmc'  Create List  ${CMD_INFORMATIONAL_ERROR}  ${CMD_UNRECOVERABLE_ERROR}  ELSE   Set Variable   ${cmd}
     ${cmd}=  Run Keyword If
     ...  '${error_log_type}' == 'Unreco_Predict' and '${system_type}' == 'bmc'  Create List  ${CMD_UNRECOVERABLE_ERROR}  ${CMD_PREDICTIVE_ERROR}  ELSE   Set Variable   ${cmd}
     ${cmd}=  Run Keyword If
     ...  '${error_log_type}' == 'Info_Unreco_Pred' and '${system_type}' == 'bmc'  Create List  ${CMD_INFORMATIONAL_ERROR}  ${CMD_UNRECOVERABLE_ERROR}
