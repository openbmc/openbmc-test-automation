...
Verify PEL Log After Host Poweron
    ...
    ${pel_bmc_infomational_error}=  Intersect Lists  ${pel_bmc_created_error}  ${pel_informational_error}

    # Get BMC created non-infomational error.
    ${pel_bmc_error}=  Subtract Lists  ${pel_bmc_created_error}  ${pel_bmc_infomational_error}
