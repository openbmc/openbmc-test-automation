...
Verify Redfish VPD Data
    ...
    ...  ELSE IF  '${component}' == 'VRM'  Set Variable  /redfish/v1/Chassis/chassis/Assembly  vdd_vrm0
    ...  ELSE IF  '${component}' == 'OP Panel'  Set Variable  /redfish/v1/Chassis/chassis/Assembly  base_op_panel_blyth
    ...  ELSE IF  '${component}' == 'OP Panel LCD'  Set Variable  /redfish/v1/Chassis/chassis/Assembly  lcd_op_panel_hill
    ...  ELSE IF  '${component}' == 'Disk Backplane'  Set Variable  /redfish/v1/Chassis/chassis/Assembly  disk_backplane0
