...
Variables       ../../data/vpd_variable.py
...
Verify VPD Via Busctl
    ...
    ${cmd}=  Catenate  ${CMD_INVENTORY_PREFIX}${component} com.ibm.ipzvpd.Location  LocationCode
    ...
    Should Be Equal  ${cmd_output[0].split('"')[1].strip('"')}  ${VPD_DETAILS['${component}']['LocationCode']}
