...
Verify VPD Component Read
    ...
    ${components}=  Get Dictionary Keys  ${vpd_records}
    FOR  ${component}  IN  @{components}
        Verify VPD Component Read Operation  ${vpd_records}  ${component}
    END
...
Verify VPD Field Read
    ...
    [Template]  Verify VPD Field Read Operation

    ${components}=  Get Dictionary Keys  ${vpd_records}
    FOR  ${component}  IN  @{components}
        Verify VPD Field Read Operation  ${vpd_records}  ${component}
    END
...
Verify VPD Field Write
    ...
    [Template]  Verify VPD Field Write Operation

    ${components}=  Get Dictionary Keys  ${vpd_records}
    FOR  ${component}  IN  @{components}
        Verify VPD Field Write Operation  ${vpd_records}  ${component}
    END
