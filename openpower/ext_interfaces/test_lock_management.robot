...
Acquire And Release Different Read Locks
    ...
    Read    ${TWO_SEG_FLAG_INVALID8}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}  ${ERR_PATTERN3}  ${True}
...
Acquire And Release Different Write Locks
    ...
    Write  ${THREE_SEG_FLAG_1}           ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    Write  ${THREE_SEG_FLAG_2}           ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    Write  ${THREE_SEG_FLAG_3}           ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    Write  ${FOUR_SEG_FLAG_1}            ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    Write  ${FOUR_SEG_FLAG_2}            ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    Write  ${FOUR_SEG_FLAG_3}            ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    Write  ${FIVE_SEG_FLAG_1}            ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    Write  ${FIVE_SEG_FLAG_2}            ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    Write  ${FIVE_SEG_FLAG_3}            ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    Write  ${SIX_SEG_FLAG_1}             ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    Write  ${SIX_SEG_FLAG_2}             ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    Write  ${SIX_SEG_FLAG_3}             ${234}       hmc-id   ${HTTP_BAD_CONFLICT}  ${EMPTY LIST}    ${True}
    ...
    Write  ${TWO_SEG_FLAG_INVALID8}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}   ${ERR_PATTERN3}  ${True}
...
Create New Session
    ...
    Run Keyword And Ignore Error  Test Teardown Execution
