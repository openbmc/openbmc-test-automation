...
@{TWO_SEG_FLAG_INVALID5}        ${LOCKSAME_LEN2}  ${LOCKALL_INVALID_LOCKFLAG3}
...
@{TWO_SEG_FLAG_INVALID8}        ${LOCKALL_INVALID_LOCKFLAG3}  ${LOCKSAME_INVALID_LEN_BOOL}
...
Acquire And Release Different Read Locks
    ...
    # lock_type  seg_flags                     resource_id  hmc_id   exp_status_code      err_msgs
    Read         ${ONE_SEG_FLAG_ALL}           ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${ONE_SEG_FLAG_SAME}          ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${ONE_SEG_FLAG_DONT}          ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${TWO_SEG_FLAG_1}             ${234}       hmc-id   ${HTTP_OK}
    Read         ${TWO_SEG_FLAG_2}             ${234}       hmc-id   ${HTTP_OK}
    Read         ${TWO_SEG_FLAG_3}             ${234}       hmc-id   ${HTTP_OK}
    Read         ${TWO_SEG_FLAG_4}             ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${TWO_SEG_FLAG_5}             ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${THREE_SEG_FLAG_1}           ${234}       hmc-id   ${HTTP_OK}
    Read         ${THREE_SEG_FLAG_2}           ${234}       hmc-id   ${HTTP_OK}
    Read         ${THREE_SEG_FLAG_3}           ${234}       hmc-id   ${HTTP_OK}
    Read         ${FOUR_SEG_FLAG_1}            ${234}       hmc-id   ${HTTP_OK}
    Read         ${FOUR_SEG_FLAG_2}            ${234}       hmc-id   ${HTTP_OK}
    Read         ${FOUR_SEG_FLAG_3}            ${234}       hmc-id   ${HTTP_OK}
    Read         ${FIVE_SEG_FLAG_1}            ${234}       hmc-id   ${HTTP_OK}
    Read         ${FIVE_SEG_FLAG_2}            ${234}       hmc-id   ${HTTP_OK}
    Read         ${FIVE_SEG_FLAG_3}            ${234}       hmc-id   ${HTTP_OK}
    Read         ${SIX_SEG_FLAG_1}             ${234}       hmc-id   ${HTTP_OK}
    Read         ${SIX_SEG_FLAG_2}             ${234}       hmc-id   ${HTTP_OK}
    Read         ${SIX_SEG_FLAG_3}             ${234}       hmc-id   ${HTTP_OK}
    Read         ${SEVEN_SEG_FLAG_1}           ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${SEVEN_SEG_FLAG_2}           ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${SEVEN_SEG_FLAG_3}           ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${LOCKSAME_INVALID_LEN1}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}  
    Read         ${LOCKSAME_INVALID_LEN_STR}   ${234}       hmc-id   ${HTTP_BAD_REQUEST}  ${ERR_PATTERN2}
    Read         ${LOCKSAME_INVALID_LEN_NEG}   ${234}       hmc-id   ${HTTP_BAD_REQUEST}  ${ERR_PATTERN2}
    Read         ${LOCKSAME_INVALID_LEN_BOOL}  ${234}       hmc-id   ${HTTP_BAD_REQUEST}  ${ERR_PATTERN2}
    Read         ${DONTLOCK_INVALID_LEN_BOOL}  ${234}       hmc-id   ${HTTP_BAD_REQUEST}  ${ERR_PATTERN2}
    Read         ${TWO_SEG_FLAG_INVALID1}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${TWO_SEG_FLAG_INVALID2}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${FOUR_SEG_FLAG_INVALID1}     ${234}       hmc-id   ${HTTP_BAD_REQUEST}  ${ERR_PATTERN2}
    Read         ${FOUR_SEG_FLAG_INVALID2}     ${234}       hmc-id   ${HTTP_BAD_REQUEST}  ${ERR_PATTERN2}
    Read         ${TWO_SEG_FLAG_INVALID3}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${TWO_SEG_FLAG_INVALID4}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Read         ${TWO_SEG_FLAG_INVALID5}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}  ${ERR_PATTERN1}
    Read         ${TWO_SEG_FLAG_INVALID6}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}  ${ERR_PATTERN1}
    Read         ${TWO_SEG_FLAG_INVALID7}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}  ${ERR_PATTERN3}
    Read         ${TWO_SEG_FLAG_INVALID8}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}  ${ERR_PATTERN3}
...
Acquire And Release Different Write Locks
    ...
    Write         ${ONE_SEG_FLAG_ALL}           ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${ONE_SEG_FLAG_SAME}          ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${ONE_SEG_FLAG_DONT}          ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${TWO_SEG_FLAG_1}             ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${TWO_SEG_FLAG_2}             ${234}       hmc-id   ${HTTP_OK}
    Write         ${TWO_SEG_FLAG_3}             ${234}       hmc-id   ${HTTP_OK}
    Write         ${THREE_SEG_FLAG_1}           ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${THREE_SEG_FLAG_2}           ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${THREE_SEG_FLAG_3}           ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${FOUR_SEG_FLAG_1}            ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${FOUR_SEG_FLAG_2}            ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${FOUR_SEG_FLAG_3}            ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${FIVE_SEG_FLAG_1}            ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${FIVE_SEG_FLAG_2}            ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${FIVE_SEG_FLAG_3}            ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${SIX_SEG_FLAG_1}             ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${SIX_SEG_FLAG_2}             ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${SIX_SEG_FLAG_3}             ${234}       hmc-id   ${HTTP_CONFLICT}
    Write         ${SEVEN_SEG_FLAG_1}           ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${SEVEN_SEG_FLAG_2}           ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${SEVEN_SEG_FLAG_3}           ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${LOCKSAME_INVALID_LEN1}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${LOCKSAME_INVALID_LEN_STR}   ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${LOCKSAME_INVALID_LEN_NEG}   ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${LOCKSAME_INVALID_LEN_BOOL}  ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${DONTLOCK_INVALID_LEN_BOOL}  ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${TWO_SEG_FLAG_INVALID1}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${TWO_SEG_FLAG_INVALID2}      ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${FOUR_SEG_FLAG_INVALID1}     ${234}       hmc-id   ${HTTP_BAD_REQUEST}
    Write         ${FOUR_SEG_FLAG_INVALID2}     ${234}       hmc-id   ${HTTP_BAD_REQUEST}
...
Return Data Dictionary For Single Request
    ...
    ${SEG_FLAGS_LOCK}=  Create Dictionary  LockType=${lock_type}  SegmentFlags=@{SegFlags}
...
Acquire And Release Lock
    ...
    Set Suite Variable  ${count}  ${${count}+1}
...
Test Setup Execution
    ...
    ${session_location}=  Redfish.Get Session Location
    ${session_key}=  Redfish.Get Session Key
    Log To Console  session=${session_location}
    Log To Console  X-AUTH-Token=${session_key}
