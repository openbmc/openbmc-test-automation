...
&{test_ipdetails_1}         Address=10.6.6.6  SubnetMask=255.255.252.0  Gateway=10.6.6.1
&{test_ipdetails_2}         Address=10.5.20.5  SubnetMask=255.255.255.0  Gateway=10.5.20.1
&{orig_ip}
${wait_time}                10s
...
Configure VMI Both Interfaces In Same Subnet And Verify
    ...
    Set To Dictionary  ${test_ipdetails_1}  SubnetMask  255.255.255.0
    Set Static IPv4 Address To VMI And Verify  ${interface_list}[0]  ${test_ipdetails_1}
    Set Static IPv4 Address To VMI And Verify  ${interface_list}[1]  ${test_ipdetails_2}
    Set To Dictionary  ${test_ipdetails_1}  SubnetMask  255.255.252.0
...
Set Static IPv4 Address To VMI And Verify
    [Documentation]  Set static IPv4 address to VMI and verify.
    [Arguments]  ${ethernet_interface}  ${ip_details}
    ...
    ${data}=  Set Variable
    ...  {"IPv4StaticAddresses": [${ip_details}]}
    ...
    ...  Verify VMI Network Interface Details  ${ip_details}[Address]  Static  ${ip_details}[Gateway]
    ...  ${ip_details}[SubnetMask]  ${ethernet_interface}


Delete VMI IPv4 Address And Verify
    [Documentation]  Delete VMI IPv4 address and verify.
...
Test Teardown Execution
    ...
    FOR  ${interface}  IN   @{interface_list}
        Delete VMI IPv4 Address And Verify  ${interface}
    END
...
Suite Teardown Execution
    ...
    FOR  ${interface}  IN   @{interface_list}
        Run Keyword If  ${vmi_network_conf_${interface}} != ${None}  Run Keywords
        ...  Set To Dictionary  ${orig_ip}  Address  ${vmi_network_conf_${interface}}[IPv4_Address]
        ...  AND  Set To Dictionary  ${orig_ip}  SubnetMask  ${vmi_network_conf_${interface}}[IPv4_SubnetMask]
        ...  AND  Set To Dictionary  ${orig_ip}  Gateway  ${vmi_network_conf_${interface}}[IPv4_Gateway]
        ...  AND  Set Static IPv4 Address To VMI And Verify
        ...  ${interface}   ${orig_ip}
    END
