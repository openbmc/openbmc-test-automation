...
Redfish Delete Partition File When Does Not Exist
    [Documentation]  Delete the partition file if do not exists.
    [Tags]  Redfish_Delete_Partition_File_When_Does_Not_Exist
    [Template]  Redfish Delete Partition File Is Not
...
Redfish Delete Partition File Is Not
    [Documentation]  Delete the partition file if do not exists.
    [Arguments]  ${file_name}
