...
Redfish Wrong URI Upload Partition File To BMC
    [Documentation]  Upload partition file to BMC using redfish.
    [Tags]  Redfish_Wrong_URI_Upload_Partition_File_To_BMC
    [Template]  Wrong URI Upload Partition File To BMC
...
Wrong URI Upload Partition File To BMC
    [Documentation]  Upload the partition file to wrong URI.
    [Arguments]  ${file_name}
