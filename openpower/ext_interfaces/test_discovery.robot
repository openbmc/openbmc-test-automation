...
Suite Setup Execution
    ...
    Login To Avahi Server  ${AVAHI_CLIENT}  ${AVAHI_CLIENT_USERNAME}  ${AVAHI_CLIENT_PASSWORD}
    Check Avahi Package
...
Discover BMC With Service Type
    ...
    Rprint Vars  AVAHI_DISCOVERY_CMD
    ${resp_service}  ${stderr}=  Execute Command  ${AVAHI_DISCOVERY_CMD['${service_type}']}  return_stderr=True
