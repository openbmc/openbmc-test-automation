...
Kill AvahiDemon And Discover BMC In Next Reboot
     [Documentation]  First kill the avahi demon and in next reboot BMC should discoverable.
     [Tags]  Kill_AvahiDemon_And_Discover_BMC_In_Next_Reboot
     [Template]  Disabled Demon And Discover BMC In Next Reboot
...
Disabled Demon And Discover BMC In Next Reboot
    ...
    Set AvahiDemon Service  command=stop
