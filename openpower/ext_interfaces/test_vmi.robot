...
Add Static IPv4 Address With Invalid Netmask
    [Documentation]  Add static IPv4 address with invalid netmask.
    [Tags]  Add_Static_IPv4_Address_With_Invalid_Netmask
    [Template]  Set Static IPv4 Address To VMI And Verify
...
Add Static IPv4 Address With Invalid Gateway
    [Documentation]  Add static IPv4 address with invalid gateway.
    [Tags]  Add_Static_IPv4_Address_With_Invalid_Gateway
    [Template]  Set Static IPv4 Address To VMI And Verify
