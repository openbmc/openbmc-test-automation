...
Enable Stateless Address AutoConfig And Verify
    [Documentation]  Enable SLAACv6 and verify an origin.
    [Tags]  Enable_Stateless_Address_AutoConfig_And_Verify
...
Set VMI SLAACv6 Origin
    ...
    # Description of argument(s):
    # slaacv6_enabled    True if user wants to enable SLACCv6. Default is Static, hence value is set to False.
