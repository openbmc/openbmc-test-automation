...
Verify Small Partition File Upload And Delete
    ...
    # file_name  size_kb  part_name  expect_resp_code     expected_msg      delete_part  username
...
Verify Partition Files Persistency And Re-upload After BMC Reboot
    ...
    Upload Partition File With Some Known Contents  ${file_name}_1  ${partition_name}_1  ${content}_${file_name}_1
    Upload Partition File With Some Known Contents  ${file_name}_2  ${partition_name}_2  ${content}_${file_name}_2
    ...
    Upload Partition File With Some Known Contents  ${file_name}_1  ${partition_name}_1  ${content}_${file_name}_2
...
Upload File To Create Partition Then Delete Partition
    ...
    ...  ${expected_msg}=File Created  ${delete_part}=${True}  ${username}=${OPENBMC_USERNAME}
...
Delete Partition And Verify On BMC
    ...
    Run Keyword If  '${username}' != '${OPENBMC_USERNAME}'  Run Keywords
    ...  Delete All Sessions And Login Using Given User  ${username}  AND
