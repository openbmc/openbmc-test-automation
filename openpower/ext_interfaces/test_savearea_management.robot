...
${MINIMUM_SIZE_MESSAGE}     File size is less than minimum allowed size[100B]
${MAXIMUM_FILE_NAME}        Filename must be maximum 20 characters
${UNSUPPORTED_FILE_NAME}    Unsupported character in filename
...
Create Samll Size Partition File
...
Redfish Upload Partition File
    ...
    [Arguments]  ${file_name}  ${file_size}=skip

    # Description of argument(s):
    # file_name    Partition file name.
    # file_size    By Default is set to skip,
    ...
    ...  Create Samll Size Partition File  ${Partition_file_list}
    ...    ELSE
