...
Upload File To Create Partition Then Delete Partition
    ...
    Verify Partition Availability After File Upload  ${partition_name}  ${upload_success}
...
Verify Partition Availability After Delete
    ...
    [Arguments]  ${partition_name}=p1  ${delete_failure}=${False}
