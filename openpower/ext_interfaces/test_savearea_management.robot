...
Verify One Thousand Partitions File Upload
    ...
    FOR  ${INDEX}  IN RANGE  1  1000
        ...
        ...  200KB  200  p${INDEX}  delete_part=${False}
        ...
        ${var_size}=  Fetch From Left  ${status}  %
        ${var_size}=  Fetch From Right  ${var_size}  ${SPACE}

        # Should be a problem if earlier request has failed when /var is not full
...
Upload File To Create Partition Then Delete Partition
    ...
    ...  ${part_name}  ${expect_resp_code}  ${user_name}
