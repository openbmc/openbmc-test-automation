...
Get CSR Request Signed By VMI For Corrupted CSR And Verify
    [Documentation]  Get CSR request signed by VMI for corrupted csr and verify.
    [Tags]  Get_CSR_Request_Signed_By_VMI_For_Corrupted_CSR_And_Verify
    [Setup]  Redfish Power On
    [Template]  Get Certificate Signed By VMI
