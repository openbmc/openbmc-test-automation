...
Required Dumps Should Exist
    ...
    #       "Name": "BMC Dump Entry"
    #   }
    #${bmc_dump}=  Redfish.Get Attribute  /redfish/v1/Managers/bmc/LogServices/Dump/Entries    Members
    ...
    #   }
    #${sys_dump}=  Redfish.Get Attribute  /redfish/v1/Systems/system/LogServices/Dump/Entries  Members
