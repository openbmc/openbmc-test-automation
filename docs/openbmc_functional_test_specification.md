...
##  Objective of OpenBMC Functional Verification Test (FVT)
...
The goal of functional verification tests is to identify problems with
...
##  Functional Verification Test (FVT) Pre-requisites
 ...
 - Test target machine must be OpenBMC supported system with both
...
Any new or re-designed OpenBmc feature falls within the scope of FVT.
That includes features from the various supported interfaces such as
