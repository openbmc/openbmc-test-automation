...
${xpath_add_new_ntp_server}       //*[contains(text(), "Add new NTP server")]
${xpath_set_time_manually}        //*[@for="manual-time"]
${xpath_set_date}                 //*[@type="date"]
${xpath_set_time}                 //*[@type="time"]
${xpath_set_time_owner}           //*[@id="date-time-owner"]
...
Verify Existence Of All Sections In Date And Time Settings Page
    ...
    ...              page.
    [Tags]  Verify_Existence_Of_All_Sections_In_Date_And_Settings_Page
...
Verify Existence Of All Buttons In Date And Time Settings Page
    ...
    ...              page.
    [Tags]  Verify_Existence_Of_All_Buttons_In_Date_And_Settings_Page
