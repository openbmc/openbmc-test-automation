...
Verify Title Text Content At OBMC Power Off State
    ...
    [Tags]    verify_title_text_content_at_obmc_power_off_state    obmc_poweroff_state
...
Verify Display Text Server Information At OBMC Power Off State
    ...
    [Tags]    verify_display_text_server_information_at_obmc_power_off_state    obmc_poweroff_state
...
Verify BMC Information Should Display At OBMC Power Off State
    ...
    [Tags]    verify_bmc_information_should_display_at_obmc_power_off_state    obmc_poweroff_state
...
Verify Power Consumption Should Display At OBMC Power Off State
    ...
    [Tags]    verify_power_consumption_should_display_at_obmc_power_off_state    obmc_poweroff_state
...
Verify High Priority Events Should Display At OBMC Power Off State
    ...
    [Tags]    verify_high_priority_events_should_display_at_obmc_power_off_state    obmc_poweroff_state
...
Verify High Priority Events Can Be Operated At OBMC Power Off State
    ...
    [Tags]    verify_high_priority_events_can_be_operated_at_obmc_power_off_state    obmc_poweroff_state
...
Verify Launching Of Serial Over LAN Console At OBMC Power Off State
    ...
    [Tags]    verify_launching_of_serial_over_lan_console_at_obmc_power_off_state    obmc_poweroff_state
...
Verify High Priority Events Can Be Operated At OBMC Power Running State
    [Documentation]    Will open the "High Priority Events"
    ...    menu to view and operate.
    [Tags]    verify_high_priority_events_can_be_operated_at_obmc_power_running_state    obmc_powerrunning_state
...
Verify Launching Of Serial Over LAN Console At OBMC Power Running State
    [Documentation]    Will open the serial over the lan command prompt window.
    [Tags]    verify_launching_of_serial_over_lan_console_at_obmc_power_running_state    obmc_powerrunning_state
    [Setup]    Test Setup Execution    ${OBMC_PowerRunning_state}
