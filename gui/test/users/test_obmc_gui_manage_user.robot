...
Verify Error When Duplicate User Is Created
    ...
    Create New User And Verify Message  user1  Passw0rd1
    Reload Page
    Sleep  2
    Page Should Contain  user1
    Create New User And Verify Message  user1  newUserPwd  msg=Username exists
...
Delete User And Verify
    ...
    Delete Non Root Users
    Create New User And Verify Message  unknownUser  passw0rd1
    Delete Non Root Users
...
Verify Invalid Password Error
    ...
    Delete Non Root Users
    Create New User And Verify Message  newUser1  newUserPwd
    Reload Page
...
Edit And Verify User Property
    ...
    Delete Non Root Users
    Create New User And Verify Message  newUser1  newUserPwd  User
    Reload Page
...
Create And Verify User Without Enabling
    ...
    Delete Non Root Users
    Create New User And Verify Message  newUser1  newUserPwd  User  False
    Click Element  ${xpath_button_logout}
    Sleep  2
    Input Text  ${xpath_textbox_username}  newUser1
    Input Password  ${xpath_textbox_password}  newUserPwd
...
Create New User And Verify Message
   [Documentation]  Do test case setup tasks.
