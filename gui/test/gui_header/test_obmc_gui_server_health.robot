...
Select All Error Logs And Mark As Resolved
    ...
    ${number_of_events}=    Get Text    ${xpath_number_of_events}
    Click Element    ${xpath_select_all_events}
    IF    ${number_of_events} > 0    Click Element    ${xpath_mark_as_resolved}
...
Select All Error Logs And Click Export
    ...
    IF    ${number_of_events} > 0    Click Element    ${xpath_events_export}
...
Select Single Error Log And Delete
    ...
    ${number_of_events}=    Get Text    ${xpath_number_of_events}
    IF    ${number_of_events} > 0
        Common Event Log Click Element    ${xpath_individual_event_delete}    ${xpath_yes_button}
    END
    ${number_of_events}=    Get Text    ${xpath_number_of_events}
    Should Be Equal    ${number_of_events}    0
...
Select Multiple Error Logs And Delete
    ...
    ${number_of_events}=    Get Text    ${xpath_number_of_events}
    IF    ${number_of_events} > 0
        Double Event Log Click Element    ${xpath_individual_event_delete}    ${xpath_yes_button}
    END
    ${number_of_events}=    Get Text    ${xpath_number_of_events}
    Should Be Equal    ${number_of_events}    0
