...
Verify Existence Of All Buttons In Local User Management Page
    ...
    Page should contain  Account policy settings
...
Verify Existence Of All Input Boxes In Local User Management Page
    ...
    Page Should Contain Element  ${xpath_select_user}
...
Delete User And Verify
    ...
    Test Login  testUser2  testUserPwd2  ${True}
...
Test Login
   ...
   [Arguments]  ${username}  ${password}  ${expected_result}=${False}
   ...
   # expected_result  Result of the test.
    ...
    Should Not Be Equal  ${status}  ${expected_result}  Login expectation was not met
