...
Verify BMC information Should Display At OBMC Power Off State
    [Documentation]  Verify existense of text "BMC information"
...
Verify POWER information Should Display At OBMC Power Off State
    [Documentation]  Verify existense of text "Power information"
...
High Priority Events Should Display At OBMC Power Off State
    [Documentation]  Verify Verif the text display.
...
Launching Of Serial Over Lan Menu At OBMC Power Off State
    [Documentation]  Will open the serial over the lan command prompt window
    [Tags]  Launching_Of_Serial_Over_Lan_Menu_At_OBMC_Power_Off_State
    ...  OBMC_PowerOff_State
...
Launching Of Serial Over Lan Menu At OBMC Power Running State
    [Documentation]  Will open the serial over the lan command prompt window
    [Tags]  Launching_Of_Serial_Over_Lan_Menu_At_OBMC_Power_Running_State
    ...  OBMC_PowerRunning_State
    [Setup]  OpenBMC Test Setup  ${OBMC_PowerRunning_state}
