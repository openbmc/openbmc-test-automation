...
*** Variables ***
# TO Do: Need to change the variable once the code finally switches to the OpenBMC.
...
Login OpenBMC GUI
    ...
    # obmc_gui_url  The URL to be opened in the browse (e.g. "https://openbmc-test.mybluemix.net/#/login").
...
LogOut OpenBMC GUI
    [Documentation]  Log of OpenBMC ASMi GUI.
