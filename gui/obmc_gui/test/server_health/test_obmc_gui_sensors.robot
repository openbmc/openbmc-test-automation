...
Documentation  Test Open BMC GUI server sensor status from server health.
...
Verify Select Sensors From Server Health
    [Documentation]  Verify ability to select sensors option from server
    ...  health sub menu.
...
Verify Sensors Export From Server Health Clickable
    [Documentation]  Verify ability to export sensors from server health
    ...  sub menu.
