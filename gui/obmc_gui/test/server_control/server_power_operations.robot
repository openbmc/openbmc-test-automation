...
Verify Title Text Should be Server Power Operations At OBMC Power Off State
    [Documentation]  Verify display of title text "Server Power Operations".
    [Tags]  Verify_Title_Text_Should_be_Server_Power_Operations_At_OBMC_Power_Off_State
    ...  OBMC_PowerOff_state

    Select Server Power Operations Sub Menu
    Verify Display Content  ${string_server_power_operations}

Verify Sub Title Text Should be Current Status At OBMC Power Off State
    [Documentation]  Verify display of title text "Current Status".
    [Tags]  Verify_Sub_Title_Text_Should_be_Current_Status_At_OBMC_Power_Off_State
    ...  OBMC_PowerOff_state

    Select Server Power Operations Sub Menu
    Verify Display Content  ${string_current_status}

Verify Sub Title Text Should be Select Power Operation At OBMC Power Off State
    [Documentation]  Verify display of title text "Select a power operation".
    [Tags]  Verify_Sub_Title_Text_Should_be_Select_Power_Operation_At_OBMC_Power_Off_State
    ...  OBMC_PowerOff_state

    Select Server Power Operations Sub Menu
    Verify Display Content  ${string_Select_power_operation}

Verify Power On Button Should Present At OBMC Power Off State
    [Documentation]  Verify presence of "Warm reboot" button.
    [Tags]  Verify_Power_On_Button_Should_Present_At_OBMC_Power_Off_State
    ...  OBMC_PowerOff_State
...
Verify Power On At OBMC Power Off State
    [Documentation]  Verify presence of "Warm reboot" button.
    [Tags]  Verify_Power_On_At_OBMC_Power_Off_State
    ...  OBMC_PowerOff_State
...
Verify Warm Reboot Button Should Present At OBMC Power Running State
    [Documentation]  Verify presence of "Warm reboot" button.
    [Tags]  Verify_Warm_Reboot_Button_Should_Present_At_OBMC_Power_Running_State
...
Verify Cold Reboot Button Should Present At OBMC Power Running State
    [Documentation]  Verify presence of "cold reboot" button.
    [Tags]  Verify_Cold_Reboot_Button_Should_Present_At_OBMC_Power_Running_State
    ...  OBMC_PowerRunning_State
    [Setup]  Test Setup Execution  ${OBMC_PowerRunning_state}
...
Verify Orderly Shutdown Button Should Present At OBMC Power Running State
    [Documentation]  Verify presence of "Orderly shutdow " button.
    [Tags]  Verify_Orderly_Shutdown_Button_Should_Present_At_OBMC_Power_Running_State
    ...  OBMC_PowerRunning_State
    [Setup]  Test Setup Execution  ${OBMC_PowerRunning_state}
...
Verify Immediate Shutdown Button Should Present At OBMC Power Running State
    [Documentation]  Verify presence of "Immediate shutdown" button.
    [Tags]  Verify_Immediate_Shutdown_Button_Should_Present_At_OBMC_Power_Running_State
    ...  OBMC_PowerRunning_State
    [Setup]  Test Setup Execution  ${OBMC_PowerRunning_state}
...
*** Keywords ***
Select Server Power Operations Sub Menu
    [Documentation]  Selecting of OpenBMC "Server Power Operations" Sub Menu.
