...
Launch Browser in Windows Platform
    ...
    ${browser}=  Get Browser Type
    Run Keyword If  '${browser}' == 'BROWSER_TYPE'
    ...     Launch Browser  ${BROWSER_TYPE}
    ...  ELSE
    ...     Launch Browser

Get Browser Type
    [Documentation]  Identify the browser to launch.

    # By default chrome browser will launch, otherwise it
    # launches user chice browser.

    ${browser_choice}=  Run Keyword And Return Status
    ...  Variable Should Exist  ${BROWSER_TYPE}

    ${browser_type}=  Run Keyword If  '${browser_choice}' == 'True'
    ...    Set Variable  BROWSER_TYPE
    ...  ELSE
    ...    Set Variable  default_browser
    [Return]  ${browser_type}
