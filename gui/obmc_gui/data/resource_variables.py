...
class resource_variables():
    ...
    xpath_display_server_power_status = "//*[@id='header__wrapper']/div/div[3]/a[3]/span"
    xpath_select_button_orderly_power_shutdown = "//*[@id='power__soft-shutdown']"
    xpath_select_button_orderly_power_shutdown_yes = "//*[@id='power-operations']/div[3]/div[5]/confirm/div/div[2]/button[1]"
