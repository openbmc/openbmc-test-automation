...
class resource_variables():
    ...
    #xpath_select_button_warm_reboot = "//button[@id='power__warm-boot']"
    xpath_warm_reboot_warning_message = "//*[@id='power-operations']/" \
        "div[3]/div[3]/confirm/div/div[1]/p[1]"
    xpath_select_button_warm_reboot_no = "//*[@id='power-operations']/div[3]" \
        "/div[3]/confirm/div/div[2]/button[2]"
    text_warm_reboot_warning_message = "Are you sure you want to warm reboot?"
    xpath_select_button_warm_reboot_yes = "//*[@id='power-operations']" \
    ...
    xpath_cold_reboot_warning_message = \
        "//*[@id='power-operations']/div[3]/div[4]/confirm/div/div[1]/p[1]"
    xpath_select_button_cold_reboot_no = \
        "//*[@id='power-operations']/div[3]/div[4]/confirm/div/div[2]/button[2]"
    text_cold_reboot_warning_message = "Are you sure you want to cold reboot?"
    xpath_select_button_cold_reboot_yes = "//*[@id='power-operations']/div[3]/div[4]/" \
    ...
    xpath_orderly_shutdown_warning_message = \
        "//*[@id='power-operations']/div[3]/div[5]/confirm/div/div[1]/p[1]/strong"
    xpath_select_button_orderly_shutdown_button_no = \
        "//*[@id='power-operations']/div[3]/div[5]/confirm/div/div[2]/button[2]"
    text_orderly_shutdown_warning_message = \
        "Are you sure you want to orderly shutdown?"
    ...
    xpath_immediate_shutdown_warning_message = \
        "//*[@id='power-operations']/div[3]/div[6]/confirm/div/div[1]/p[1]"
    xpath_select_button_immediate_shutdown_no = "//*[@id='power-operations']/div[3]/" \
        "div[6]/confirm/div/div[2]/button[2]"
    text_immediate_shutdown_warning_message = "Are you sure you want to immediate shutdown?"
    xpath_select_button_immediate_shutdown_yes = \
        "//*[@id='power-operations']/div[3]/div[6]/confirm/div/div[2]/button[1]"
