...
Power Off Server
    ...
    ELSE
        ...
        Wait Until Keyword Succeeds  5m  45s  Check Boot Progress State Via Redfish  None
    END
...
Power On Server
    ...
    ELSE
        ...
        Verify Information Message Via GUI
        Wait Until Keyword Succeeds  10m  45s  Check Boot Progress State Via Redfish  OSRunning
    END
...
Check Boot Progress State Via Redfish
    ...
    Should Be Equal As Strings  ${boot_state}  ${expected_state}
