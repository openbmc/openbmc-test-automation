...
Power Off Server
    ...
    ELSE
        ...
        #Wait Until Keyword Succeeds  15m  45s  Reload Page And Check Power Status  ${xpath_power_poweron}
...
Power On Server
    ...
    ELSE
        ...
        #Wait Until Element Is Visible  ${xpath_power_shutdown}  timeout=200s
        Verify And Close Information Message Via GUI
        #Wait Until Keyword Succeeds  15m  45s  Reload Page And Check Power Status  ${xpath_power_shutdown}
