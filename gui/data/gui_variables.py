...
class gui_variables:
    ...
    xpath_unauthorized_message = "//span[contains(normalize-space(.),'Unauthorized')]"
    ...
    xpath_server_failure_message = (
        "//span[contains(normalize-space(.),'Factory reset of server settings failed.')]"
    )
    xpath_bmc_server_failure_message = (
        "//span[contains(normalize-space(.),'Factory reset of BMC and server settings failed.')]"
    )
    ...
    overview_hyperlinks = {
        ...
        "xpath_overview_power_hp": (
            "//a[@href='#/resource-management/power']",
            "Power",
        ),
        "xpath_overview_event_logs_hp": (
            "//a[@href='#/logs/event-logs']",
            "Event logs",
        ),
        "xpath_overview_inventory_and_leds_hp": (
            "//a[@href='#/hardware-status/inventory']",
            "Inventory and LEDs",
        ),
