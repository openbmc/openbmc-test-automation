...
class gui_variables:
    ...
    overview_hyperlinks = {
        'xpath_overview_firmware_hp': ("//a[@href='#/operations/firmware']", 'Firmware'),
        'xpath_overview_network_hp': ("//a[@href='#/settings/network']", 'Network'),
        'xpath_overview_power_hp': ("//a[@href='#/resource-management/power']", 'Power'),
        'xpath_overview_event_logs_hp': ("//a[@href='#/logs/event-logs']", 'Event logs'),
        'xpath_overview_inventory_and_leds_hp': ("//a[@href='#/hardware-status/inventory']",
         'Inventory and LEDs'),
        'xpath_overview_dumps_hp': ("//a[@href='#/logs/dumps']", 'Dumps')
}