...
class gui_variables:
    ...
    # Success,Error and Unauthorized variables
    xpath_success_message = "//*[contains(text(),'Success')]"
    xpath_error_popup = "//*[contains(text(),'Error')]/following-sibling::button"
    xpath_Unauthorized_popup = "//*[contains(text(),'Unauthorized')]/following-sibling::button"
