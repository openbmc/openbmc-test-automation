...
${xpath_page_loading_progress_bar_path}     //*[@aria-label='Page loading progress bar']
*** Test Cases ***
...
Suite Setup Execution
    ...
    Wait Until Element Is Not Visible   ${xpath_page_loading_progress_bar_path}  timeout=30
