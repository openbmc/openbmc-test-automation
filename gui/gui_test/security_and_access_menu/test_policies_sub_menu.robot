...
Disable SSH Via GUI And Verify Persistency On BMC Reboot
    ...
    [Teardown]  Run Keywords  Wait Until Keyword Succeeds  60 sec  30 sec  Enable SSH Protocol  ${True}
    ...  AND  Wait Until Keyword Succeeds  5 min  1 min  Open Connection And Login
...
Disable IPMI Via GUI And Verify Persistency On BMC Reboot
    ...
    [Teardown]  Run Keywords  Wait Until Keyword Succeeds  30 sec  15 sec  Enable IPMI Protocol  ${True}
    ...  AND  Wait Until Keyword Succeeds  30 sec  10 sec  Run IPMI Standard Command  sel info
