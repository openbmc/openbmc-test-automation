...
Enable SSH Via GUI And Verify
    ...
    Set Policy Via GUI  ${xpath_bmc_ssh_toggle}  Enabled
...
Disable SSH Via GUI And Verify
    ...
    Set Policy Via GUI  ${xpath_bmc_ssh_toggle}  Disabled
...
Disable IPMI Via GUI And Verify
    ...
    Set Policy Via GUI  ${xpath_network_ipmi_toggle}  Disabled
...
Enable IPMI Via GUI And Verify
    ...
    Set Policy Via GUI  ${xpath_network_ipmi_toggle}  Enabled
    Wait Until Keyword Succeeds  10 sec  5 sec  Run IPMI Standard Command  sel info
...
Set Policy Via GUI
    ...
    # policy  xpath of SSH/IPMI toggle.
    ...
    Wait Until Keyword Succeeds  1 min  10 sec
    ...  Refresh GUI And Verify Element Value  ${policy}  ${state}
