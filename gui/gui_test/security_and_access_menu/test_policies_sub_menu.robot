...
Toggle Required Policy Option And Verify
    ...
    [Arguments]  ${initial_option_value}  ${input_xpath_toggle_option}
    ...  ${expected_toast_msg}

    # Description of argument(s):
    # initial_option_value         Intial policy option value.
    # input_xpath_toggle_option    Input required xpath toggle option.
    ...
    click element  ${input_xpath_toggle_option} 
    page should contain  ${expected_toast_msg}
    # wait for gui to reflect policy status.
    wait until keyword succeeds  1 min  30 sec
    ...  refresh gui and verify element value  ${input_xpath_toggle_option}  ${expected_toggle_status}
    ...
    # wait for gui to reflect policy status.
    wait until keyword succeeds  1 min  30 sec
    ...  refresh gui and verify element value  ${input_xpath_toggle_option}  ${next_expected_toggle_status}


Set Basic Authentication Policy To Initial State
    [Documentation]  Set basic authentication policy option to intial state.
