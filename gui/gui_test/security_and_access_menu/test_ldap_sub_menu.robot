...
Verify Mandatory Privileges Visible In Group Privilege Options
    ...
    [Tags]  Verify_Mandatory_Privileges_Visible_In_Group_Privilege_Options
    ...
    # Check for optional privileges (Operator and No Access).
