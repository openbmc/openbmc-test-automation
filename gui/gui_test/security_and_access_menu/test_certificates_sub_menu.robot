...
Install Multiple CA Certificates And Verify
    ...
    [Teardown]  Run Keywords  Redfish.Login  AND  Delete All CA Certificate Via Redfish  AND
    ...  Install And Verify Certificate Via Redfish  CA  Valid Certificate  ok  ${FALSE}  AND  Redfish.Logout
    ...
    # Install CA certificates to reach maximum count of 3.
    FOR  ${INDEX}  IN RANGE  ${cert_count}  3
