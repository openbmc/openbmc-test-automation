...
Load Certificates On BMC Via GUI
    ...
    ...  Run Keywords  Wait Until Page Contains  Error adding certificate.  AND
    ...  Wait Until Page Does Not Contain  Error adding certificate.  timeout=10  AND  Return From Keyword
    ...
    Wait Until Page Does Not Contain  Successfully added ${certificate_type}.  timeout=10
