...
@{static_name_servers}      10.10.10.10  10.5.5.10
...
DNS Test Setup Execution
    ...
    ...  Delete DNS Server And Verify  ${original_nameserver}
...
DNS Test Teardown Execution
    ...
    Run Keyword If  ${original_name_server} != @{EMPTY}
    ...  Add DNS Server And Verify  ${original_nameserver}
