...
Add DNS Server And Verify
    ...
    FOR  ${i}  IN RANGE  ${length}
      ...
      Append To List  ${dns_servers}  ${static_name_servers}[${i}]
    END
    ...
    List Should Contain Sub List  ${cli_name_servers}  ${dns_servers}
...
Delete DNS Server And Verify
    ...
    FOR  ${i}  IN RANGE   ${length}
       ...
       Exit For Loop If   "${status}" == "False" or ${i} == ${3}
