...
Verify System Section In Network Setting page
    [Documentation]  Verify hostname, MAC address and default gateway under system section of network setting page.
    ...
    Textfield Value Should Be  ${xpath_default_gateway_input}  ${test_gateway}
