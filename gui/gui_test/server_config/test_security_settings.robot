...
${xpath_bmcShell_toggle}            //*[@data-test-id='security-toggle-bmcShell']
${xpath_networkIpmi_toggle}         //*[@data-test-id='security-toggle-networkIpmi']
...
Verify Existence Of All Buttons In Security Settings Page
    ...
    Page Should Contain Element  ${xpath_bmcShell_toggle}
    Page Should Contain Element  ${xpath_networkIpmi_toggle}
