...
${xpath_ClearAll_radio}                    //input[@value='ALL']
${xpath_ClearHypervisorSystemKey_radio}    //input[@value='POWERVM_SYSKEY']
...
Verify Existence Of All Buttons In Key Clear Page
    ...
    Page Should Contain Element  ${xpath_ClearAll_radio}
    Page Should Contain Element  ${xpath_ClearHypervisorSystemKey_radio}
