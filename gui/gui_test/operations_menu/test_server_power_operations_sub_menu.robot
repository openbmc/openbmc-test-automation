...
Verify Server Power Operations Page With Readonly User With Host On State
    [Documentation]  Verify Server Power Operations page with readonly user when Host On state.
    [Tags]  Verify_Server_Power_Operations_Page_With_Readonly_User_With_Host_On_State
...
Verify Server Power Operations Page With Readonly User With Host Off State
    [Documentation]  Verify Server Power Operations page with readonly user when Host Off state.
    [Tags]  Verify_Server_Power_Operations_Page_With_Readonly_User_With_Host_Off_State
...
Verify Save Button With Readonly User
    ...
    [Setup]  Run Keywords  Create Readonly User And Login To GUI  AND  Navigate to Server Power Operation Page
    [Teardown]  Delete Readonly User And Logout Current GUI Session
