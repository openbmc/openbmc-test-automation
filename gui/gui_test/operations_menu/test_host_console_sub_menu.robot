...
Verify Existence Of All Sections In Host Console Page
    [Documentation]  Verify existence of all sections in Host console page.
    [Tags]  Verify_Existence_Of_All_Sections_In_Host_Console_Page

    Page Should Contain  Host console redirects the server's serial port output to this window.
