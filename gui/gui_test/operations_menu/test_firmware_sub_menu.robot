...
Verify Image Signature
    ...
    ${verify}=  Run
    ...  openssl dgst -sha256 -verify /tmp/fw_verify/publickey -signature /tmp/fw_verify/${image}.sig /tmp/fw_verify/${image}

    Should Contain  ${verify}  Verified OK
    ...  msg=${image} signature verification failed: ${verify}
    Log To Console  ${image}: ${verify}
