...
Verify Valid Signed BMC Firmware
    ...
    ${rc}=  Run And Return Rc  tar -xf ${IMAGE_FILE_PATH} -C ${fw_verify_dir}/
...
Verify Image Signature
    ...
    ${verify}=  Run
    ...  openssl dgst -sha256 -verify ${fw_verify_dir}/publickey -signature ${fw_verify_dir}/${image}.sig ${fw_verify_dir}/${image}
