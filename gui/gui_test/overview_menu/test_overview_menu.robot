...
Verify Service User Disabled Status On Overview Page
    ...
    # Verify status on Overview page.
    ...
    Set Service User Status  Enabled
...
Set Service User Status
    ...
    Navigate To Required Sub Menu  ${xpath_secuity_and_accesss_menu}  ${xpath_user_management_sub_menu}
    ...  user-management
