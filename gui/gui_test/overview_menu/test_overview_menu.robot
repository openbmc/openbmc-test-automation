...
Verify View More Button Contains Server information
    [Documentation]  Verify view more button Contains Server information in overview page.
    [Tags]  Verify_View_More_Button_Contains_Server_information
...
Verify View More Button Contains Firmware information
    [Documentation]  Verify view more button contains Firmware information in overview page.
