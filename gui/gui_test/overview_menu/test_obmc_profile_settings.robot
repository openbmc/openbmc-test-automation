...
${xpath_logged_usename}    //*[contains(text(),'Username')]/following-sibling::dd
...
Verify Logged In Username
    ...
    ${gui_header_text}=  Get Text  ${xpath_logged_usename}
    Should Contain  ${gui_header_text}  ${OPENBMC_USERNAME}
