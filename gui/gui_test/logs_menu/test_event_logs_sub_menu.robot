...
Verify Existence Of All The Expected Fields In Event LogsPage
    [Documentation]  Verify existence of all the expected fields in Event Logs page.
    [Tags]  Verify_Existence_Of_All_The_Expected_Fields_In_Event_Logs_Page
