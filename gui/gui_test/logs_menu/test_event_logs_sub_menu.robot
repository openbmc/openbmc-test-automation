...
Verify Resolving Single Error Log In GUI
    ...
    ${resolved_status}=  Get Event Logs Status From Redfish
    Should Not Contain  ${resolved_status}  ${True}
    ...
    ${resolved_status}=  Get Event Logs Status From Redfish
    Should Not Contain  ${resolved_status}  ${False}
...
Get Event Logs Status From Redfish
    ...
    FOR  ${member}  IN  @{members}
        ${status}=  Get From Dictionary  ${member}  Resolved
        Append To List  ${events_status}  ${status}
    END
