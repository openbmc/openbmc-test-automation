...
Verify Existence Of All The Expected Fields In Progress Logs Page
    [Documentation]  Verify existence of all the Fields in Progress Logs page.
    [Tags]  Verify_Existence_Of_All_The_Fields_In_Progress_Logs_Page
