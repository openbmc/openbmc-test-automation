...
Documentation  Test OpenBMC GUI "Notices" menu.
...
Verify Existence Of All Sections In Notices Page
    [Documentation]  Login to GUI and perform page navigation to notices page
    ...  and check if all visible sections is actually loaded successfully.
    [Tags]  Verify_Existence_Of_All_Sections_In_Notices_Page
