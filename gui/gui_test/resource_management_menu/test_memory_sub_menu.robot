...
Verify Navigate To Memory Page
    [Documentataions]  Login to GUI and perform page navigation to memory page and verify it loads successfully.
...
Verify Existence Of All Sections In Memory Page
    ...
    ...  check if all visible sections is actually loaded successfully.e
