...
Verify Server Power Cap Setting Is On
    ...
    ${resp}=  Redfish.Get Properties  /redfish/v1/Chassis/chassis/EnvironmentMetrics

    ${power_cap_value}=  Evaluate  random.randint(${resp['PowerLimitWatts']['AllowableMin']}, ${resp['PowerLimitWatts']['AllowableMax']})  modules=random
