...
${snmp_alerts_page_heading}                       SNMP alerts
...
Verify Existence Of All Fields In Add Destination
    ...
    ...  Refresh GUI And Verify Element Value  ${xpath_snmp_alerts_heading}  ${snmp_alerts_page_heading}
...
Configure Multiple SNMP Managers On BMC Via GUI And Verify Persistency On BMC Reboot
    ...
    Wait Until Page Contains  ${snmp_alerts_page_heading}  timeout=1min
...
Delete SNMP Manager Via GUI
    ...
    ...  ${xpath_snmp_alerts_heading}  ${snmp_alerts_page_heading}
