...
Configure SNMP Manager With Valid FQDN Via GUI And Verify
    ...
    [Tags]  Configure_SNMP_Manager_With_Valid_FQDN_Via_GUI_And_Verify
    ...
    # Configure SNMP manager using the FQDN via GUI.
