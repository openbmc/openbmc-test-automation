...
Configure Multiple SNMP Settings On BMC Via GUI And Verify
    [Documentation]  Configure multiple SNMP settings on BMC via GUI and verify.
    [Tags]  Configure_Multiple_SNMP_Settings_With_Default_Port_Via_GUI_And_Verify
    [Template]  Configure Multiple SNMP Managers On BMC With Valid Port Via GUI And Verify

    # snmp_ip_value      snmp__port_value
...
Configure Multiple SNMP Settings With Non Default Port Via GUI And Verify
    [Documentation]  Configure multiple SNMP settings with non-default port via GUI and verify.
    [Tags]  Configure_Multiple_SNMP_Settings__With_Non_Default_Port_Via_GUI_And_Verify
    [Template]  Configure Multiple SNMP Managers On BMC With Valid Port Via GUI And Verify
...
Configure Multiple SNMP Settings With Different Ports Via GUI And Verify
    [Documentation]  Configure multiple SNMP settings with different ports via GUI and verify.
    [Tags]  Configure_Multiple_SNMP_Settings_With_Different_Ports_Via_GUI_And_Verify
    [Template]  Configure Multiple SNMP Managers On BMC With Valid Port Via GUI And Verify
