...
Enable Eth0 IPv6 AutoConfig and Verify SLAAC
    [Documentation]  Login to GUI network page, enable SLAAC and check it is set to Enable state.
...
Disable Eth0 IPv6 AutoConfig and Verify SLAAC
    [Documentation]  Login to GUI network page, enable SLAAC and check it is set to Disable state.
...
Set IPv6 AutoConfig State
    ...
    # xpath_ipv6_autoconfig_button  xpath of etho or eth1 ipv6 autoconfig button.
    ...
    IF    '${desired_autoconfig_state}' == '${current_autoconfig_state}'
        ...
        ...  ${xpath_page_loading_progress_bar}  timeout=120s
        Click Element     ${xpath_ipv6_autoconfig_button}
        Element Text Should Be    ${xpath_ipv6_autoconfig_button}    ${desired_autoconfig_state}    timeout=60sec
