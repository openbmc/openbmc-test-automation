...
Delete IPv6 Address And Verify BMC Connection
    ...
    # Verify the deleted IPv6 address no longer exists on BMC.
    ${status}=  Run Keyword And Return Status  Verify IPv6 On BMC  ${ipv6_addr_to_delete}
    Should Be Equal  ${status}  ${False}
    ...  msg=IPv6 address ${ipv6_addr_to_delete} still exists on BMC.
