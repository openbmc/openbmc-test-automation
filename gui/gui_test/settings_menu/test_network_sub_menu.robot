...
${ipv4_addr_origin_elements}             //h2[contains(text(),'IPv4')]//following::table[1]//tbody/tr/td[4]
${ipv6_addr_origin_elements}             //h2[contains(text(),'IPv6')]//following::table[1]//tbody/tr/td[3]
