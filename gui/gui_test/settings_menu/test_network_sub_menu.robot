...
Verify Coexistence Of IPv6 Addresses
    [Documentation]  verify coexistence of IPv6 Addresses, DHCPv6 and SLAAC setup must be present.
    [Tags]  Verify_Coexistence_Of_IPv6_Addresses
    [Setup]  Run Keywords  Add Static IPv6 Address And Verify Via GUI  ${test_ipv6_addr}  ${test_prefix_length}  Success
    ...  AND  Set And Verify DHCPv6 States  Enabled  Enabled  AND  Set SLAAC Property On Eth0 And Eth1  AND
    ...  Add Static IPv6 Address And Verify Via GUI  ${test_ipv6_addr}  ${test_prefix_length}  Success  None  2
...
Coexistence Of IPv6 Addresses
    ...
    ${all_origin}=  Get WebElements  //h2[contains(text(),'IPv6')]//following::table[1]//td[@aria-colindex='3']
