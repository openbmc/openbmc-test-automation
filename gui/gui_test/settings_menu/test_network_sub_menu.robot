...
${xpath_save_button}                     //div[@class='modal fade show']//button[@type='button'][normalize-space()='Save']
...
${xpath_success_popup}                   (//div[@class='toast text-bg-success show toast-top-right'])[1]
