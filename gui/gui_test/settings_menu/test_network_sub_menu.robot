...
Modify Default IPv6 Gateway And Verify
    ...
    # Description of argument(s):
    # old_ip       The existing IPv6 address visible on GUI.
    # new_ip       The new IPv6 address to update.
    ...
    # Verify IP via redfish.
    ${edit_status}=  Run Keyword And Return Status  Get Static Default Gateway Property Via Redfish
    Should Be Equal  ${edit_status}  ${True}
