...
${xpath_ntp_radio_button}                //*[@id="useNtpSwitch"]/following-sibling::label
${xpath_dns_radio_button}                //*[@id="useDnsSwitch"]/following-sibling::label
${xpath_domainname_radio_button}         //*[@id="useDomainNameSwitch"]/following-sibling::label
...
Toggle DHCPv4 Properties Radio Buttons Via GUI And Verify
    [Documentation]  Toggle DHCPv4 properties radio buttons via GUI And verify.
    [Tags]  Toggle_DHCPv4_Properties_Radio_Buttons_Via_GUI_And_Verify
    [Template]  Toggle DHCPv4 property And Verify

    ${xpath_ntp_radio_button}
    ${xpath_dns_radio_button}
    ${xpath_domainname_radio_button}
