...
Verify Setting Power Restore Policy With Available Options With Readonly User
    [Documentation]  Verify setting Power restore policy with available options readonly user.
    [Tags]  Verify_Setting_Power_Restore_Policy_With_Available_Options_With_Readonly_User
    [Setup]  Set Server Operating Mode  Normal
