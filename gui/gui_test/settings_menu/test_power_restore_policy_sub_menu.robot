...
Verify Setting Power Restore Policy TO Available Options With Readonly User
    ...
    [Setup]  Run Keywords  Set Server Operating Mode  Normal  AND  Logout GUI
    ...      AND  Create Readonly User And Login To GUI
    ...      AND  Navigate To Required Sub Menu  ${xpath_settings_menu}
...
Verify Power Restore Policy Options Disabled In Manual Mode With Readonly User
    ...
    [Setup]  Run Keywords  Set Server Operating Mode  Manual  AND  Logout GUI
    ...      AND  Create Readonly User And Login To GUI
    ...      AND  Navigate To Required Sub Menu  ${xpath_settings_menu}
    ...      ${xpath_power_restore_policy_sub_menu}  power-restore-policy
