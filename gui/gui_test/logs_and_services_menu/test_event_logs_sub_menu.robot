...
${xpath_event_logs_unresolve}     //button[contains(normalize-space(.),'Unresolve')]
...
Verify Resolving And Unresolving Multiple Error Logs In GUI
    ...
    Click Element  ${xpath_event_logs_unresolve}

    # Check the pop up message to ensure they are unresolved.
    Wait Until Page Contains  Successfully unresolved ${number_of_events_before} logs.  timeout=10
