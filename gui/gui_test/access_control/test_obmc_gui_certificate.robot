...
${xpath_generate_csr_heading}    //h5[text()="Generate a Certificate Signing Request (CSR)"]
${xpath_certificate_type}        //*[@data-test-id='modalGenerateCsr-select-certificateType']
${xpath_select_country}          //*[@data-test-id='modalGenerateCsr-select-country']
${xpath_state}                   //*[@data-test-id='modalGenerateCsr-input-state']
${xpath_city}                    //*[@data-test-id='modalGenerateCsr-input-city']
${xpath_company_name}            //*[@data-test-id='modalGenerateCsr-input-companyName']
${xpath_company_unit}            //*[@data-test-id='modalGenerateCsr-input-companyUnit']
${xpath_common_name}             //*[@data-test-id='modalGenerateCsr-input-commonName']
${xpath_challenge_password}      //*[@data-test-id='modalGenerateCsr-input-challengePassword']
${xpath_contact_person}          //*[@data-test-id='modalGenerateCsr-input-contactPerson']
${xpath_email_address}           //*[@data-test-id='modalGenerateCsr-input-emailAddress']
${xpath_generate_csr_submit}     //*[@data-test-id='modalGenerateCsr-button-ok']
${xpath_alternate_name}          //*[@class='d-flex']
...
Verify Generate CSR Certificate Button
    [Documentation]  Verify existence of buttons for CSR generation.
    [Tags]  Verify_Generate_CSR_Certificate_Button
     ...
     Page Should Contain Element  ${xpath_certificate_type}
     Page Should Contain Element  ${xpath_select_country}
     Page Should Contain Element  ${xpath_state}
     Page Should Contain Element  ${xpath_city}
     Page Should Contain Element  ${xpath_company_name}
     Page Should Contain Element  ${xpath_common_name}
     Page Should Contain Element  ${xpath_challenge_password}
     Page Should Contain Element  ${xpath_contact_person}
     Page Should Contain Element  ${xpath_email_address}
     Page Should Contain Element  ${xpath_alternate_name}
