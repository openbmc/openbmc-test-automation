...
*** Variables ***
${xpath_select_user}          //*[@id="__BVID__94"]
${xpath_root_user}            //*[@id="__BVID__211"]
${xpath_account_policy}       //button[text()=' Account policy settings ']
${xpath_add_user}             //button[text()=' Add user ']
${xpath_edit_user}            //button[@aria-label="Edit user"]
${xpath_delete_user}          //button[@aria-label="Edit user"]
...
Verify Existence Of All Input Boxes In Local User Management Page
    ...
    Page Should Contain Checkbox  ${xpath_root_user}
