...
i${xpath_radio_account_status_enabled}   //*[@data-test-id='localUserManagement-radioButton-statusEnabled']
...
Verify Disable User
    ...
    Redfish.Logout
    ${status}=  Run Keyword And Return Status  Redfish.Login  DisabledUser  ${password}
