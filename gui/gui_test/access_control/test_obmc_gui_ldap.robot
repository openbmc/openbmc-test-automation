...
${xpath_openl_ldap_radio_button}        //div[@class='custom-control custom-radio']/input[@value='false']
${xpath_active_directory_radio_button}  //div[@class='custom-control custom-radio']/input[@value='true']
