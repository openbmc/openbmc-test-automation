...
Send ICMP Timestamp Request
    ...
    ...  ${OPENBMC_HOST}  icmp  ${NETWORK_PORT}  ${ICMP_TIMESTAMP}
    Should Contain  ${bmc_packet_loss}  Lost: ${count} (100.00%)
...
Send Network Packets
    ...
    [Arguments]  ${host}  ${packet_type}=icmp  ${port}=80  ${icmp_type}=${ICMP_ECHO_REQUEST}
