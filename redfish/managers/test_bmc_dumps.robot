...
Verify Maximum BMC Dump Creation
    ...
    # Maximum allowed space for dump is 409600 KB. BMC typically hold 400 dumps
    # before running out of this dump space. So trying to create dumps in 1000 
