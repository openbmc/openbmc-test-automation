...
Verify User Initiated BMC Dump Type
    ...
    ${extracted_dump_folder}=  Find Extracted BMC Dump Folder  ${dump_creation_timestamp}
...
Find Extracted BMC Dump Folder
   [Documentation]  Find the folder the BMC dump got extracted.
