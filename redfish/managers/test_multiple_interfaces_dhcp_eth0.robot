...
Test Teardown   Run Keywords  FFDC On Test Case Fail
...             AND  Run Keyword And Ignore Error  Set DHCPEnabled Via Eth1  True  eth0
...
Get Address Origin List And IPv4 or IPv6 Address Via Eth1
    ...
    [Arguments]  ${ip_address_type}  ${channel_number}=${1}
