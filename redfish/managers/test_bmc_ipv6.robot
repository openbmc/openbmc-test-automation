...
Verify Linklocal Address Has Network Part Fe80 And Network Part As EUI64
    [Documentation]  Verify linklocal address has host part as fe80 and network part as EUI64.
    [Tags]  Verify_Linklocal_Address_Has_Network_Part_Fe80_And_Host_Part_As_EUI64

    Linklocal Address Has Network Part Fe80 And Host Part as EUI64
...
Linklocal Address Has Network Part Fe80 And Host Part as EUI64
    [Documentation]  Linklocal address has network part fe80 and host part as EUI64.
