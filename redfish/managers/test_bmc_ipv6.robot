...
${ipv6_leading_zero1}        2001:0022:1133::1111
...
Configure IPv6 And Verify It Is Getting Configured As Expected
    [Documentation]  Configure IPv6 & verify it is getting configured as expected valid format.
    [Tags]  Configure_IPv6_And_Verify_It_Is_Getting_Configured_As_Expected
    [Teardown]  Run Keywords
    ...
    ${ipv6_leading_zero1}    ${test_prefix_length}  ${ipv6_eliminate_zero1}
