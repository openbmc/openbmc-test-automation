...
Check Static IPv6 is Pinging
    ...
    # gsa_login     GSA username to login to the DHCP server.
    # gsa_password  GSA password to login to the DHCP server.

    ${cmd}=  Set Variable
    ...  sshpass -p ${GSA_PASSWORD} ssh -o StrictHostKeyChecking=no ${GSA_USERNAME}@${dhcp_server} ping6 -W 1 -c 2 ${ipv6_address}
