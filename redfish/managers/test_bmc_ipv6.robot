...
Modify Static Default Gateway And Verify
    ...
    Configure IPv6 Static Default Gateway On BMC  ${ipv6_gw_addr}  ${prefix_length_def}  ${HTTP_OK}

    Modify Static Default Gateway  ${ipv6_gw_addr}  ${test_ipv6_addr1}  ${prefix_length_def}
