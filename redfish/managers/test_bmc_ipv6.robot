...
Configure or Modify IPv6 Static Default Gateway On BMC
    ...
    FOR  ${ipv6_static_def_gw}  IN  @{ipv6_static_def_gw}
        ${old_static_def_gw_not_none}=    Run Keyword And Return Status    Should Not Be Equal    ${old_static_def_gw}    ${None}
        ${old_static_def_gw_eq_ipv6}=    Run Keyword And Return Status    Should Be Equal    ${ipv6_static_def_gw['Address']}    ${old_static_def_gw}
        IF  ${old_static_def_gw_not_none} and ${old_static_def_gw_eq_ipv6}
