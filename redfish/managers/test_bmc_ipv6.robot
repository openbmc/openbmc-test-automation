...
Verify All Configured IPv6 And PrefixLength On BMC
    ...
    [Tags]  Verify_IPv6_And_PrefixLength_On_BMC
...
Configure IPv6 Address And Verify
    ...
    Configure IPv6 Address On BMC  ${test_ipv6_address}  ${test_prefix_length}
...
Configure IPv6 Address On BMC
    ...
    [Arguments]  ${ipv6}  ${prefix_len}  ${valid_status_codes}=${HTTP_OK}

    # Description of argument(s):
    # ipv6                IPv6 address to be added (e.g. "2001:EEEE:2222::2022").
    ...
    ${ipv6_data}=  Create Dictionary  Address=${ipv6}
    ...  PrefixLength=${prefix_len}

    ${patch_list}=  Create List

    # Existing static IPv6 configurations on BMC.
    ${ipv6_network_configurations}=  Get IPv6 Network Configuration
    ...
    Verify IPv6 And PrefixLength On BMC  ${ipv6}  ${prefix_len}

    # Verify existing static IPv6 addresses still exist.
    FOR  ${ipv6_network_configuration}  IN  @{ipv6_network_configurations}
      Verify IPv6 On BMC  ${ipv6_network_configuration['Address']}
    END
