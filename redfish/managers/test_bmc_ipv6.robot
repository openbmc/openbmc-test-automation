...
Verify Coexistence Of All IPv6 Type Addresses On BMC
    ...
    Check Coexistence Of All IPv6 Type Addresses On BMC
...
Check Coexistence Of All IPv6 Type Addresses On BMC
    [Documentation]  Verify link local, static, DHCPv6 and SLAAC ipv6 addresses coexist.

    # Verify the address origin contains link local, static ipv6, DHCPv6 and SLAAC.
    Verify The Coexistance Of The Address Type  LinkLocal  Static  DHCPv6  SLAAC