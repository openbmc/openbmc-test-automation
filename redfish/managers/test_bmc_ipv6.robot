...
Configure Static IPv4 On Both Interfaces And Verify Configuring Static IPv6
    ...
    [Tags]  Configure_Static_IPv4_On_Both_Interfaces_And_Verify_Configuring_Static_IPv6
