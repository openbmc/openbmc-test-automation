...
Verify Eth1 DHCPv4 Functions Properly In The Presence Of DHCPv6
    [Documentation]  Verify eth1 dhcpv4 functions properly in the presence of dhcpv6.
    [Tags]  Verify_Eth1_DHCPv4_Functions_Properly_In_The_Presence_Of_DHCPv6
    [Setup]  Run Keywords
    ...  Set DHCPEnabled To Enable Or Disable  True  eth1
...
Verify DHCPv4 Functionality
    [Documentation]  Verify dhcpv4 functions properly.
