...
Wait For IPv6 Host To Ping
    [Documentation]  Wait For IPv6 Host to Ping
    [Tags]  Wait_For_IPv6_Host_To_Ping
    ...
    Wait Until Keyword Succeeds  ${timeout}  ${interval}  SSHLibrary.Execute Command  ping6 -c 3 ${host}
