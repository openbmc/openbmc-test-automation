...
Check BMC Gets SLAAC Address
    ...
    #Should Not Be Empty  ${ipv6_slaac_addr}  msg=SLAAC address is not present.


Get The Initial DHCPv6 Setting On Each Interface
    [Documentation]  Get the initial DHCPv6 setting on each variable.
...
Get The Initial DHCPv6 Settings
    ...
    Run Keywords  Get The Initial DHCPv6 Setting On Each Interface  ${1}
    ...  AND  Get The Initial DHCPv6 Setting On Each Interface  ${2}


Get The Initial SLAAC Settings
    [Documentation]  Get the initial SLAAC settings of both the interfaces.

    Run Keywords  Get The Initial SLAAC Setting On Each Interface  ${1}
    ...  AND  Get The Initial SLAAC Setting On Each Interface   ${2}


Get The Initial SLAAC Setting On Each Interface
    [Documentation]  Get the initial SLAAC setting and store in a variable.
    [Arguments]  ${channel_number}
...
Verify All The Addresses Are Intact
    [Documentation]  Verify all the addresses are intact.
