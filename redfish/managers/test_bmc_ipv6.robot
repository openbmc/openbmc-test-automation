...
Set DHCPv6 Property
    ...
    [Arguments]  ${dhcpv6_operatingmode}=${Disabled}  ${valid_status_code}=[${HTTP_OK},${HTTP_NO_CONTENT}]
    ...  ${interface}=${ethernet_interface}

    # Description of argument(s):
    # dhcpv6_operatingmode    Enabled if user wants to enable DHCPv6.
    # valid_status_code       Expected valid status code.
    ...
    Run Keyword If  '${dhcpv6_verify['OperatingMode']}' != '${dhcpv6_operatingmode}'
