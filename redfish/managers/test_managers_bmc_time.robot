...
Verify NTP Server Setting Available After BMC Reboot
    [Documentation]  Verify NTP server setting available after BMC reboot.
    [Tags]  Verify_NTP_Server_Setting_Available_After_BMC_Reboot
