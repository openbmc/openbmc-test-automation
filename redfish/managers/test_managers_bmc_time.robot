...
Verify Set Timezone To Asia Tokyo
    [Documentation]  Set timezone to Asia/Tokyo and verify properties.
    [Tags]  Verify_Set_Timezone_To_Asia_Tokyo
...
Verify Set Timezone To Australia Darwin
    [Documentation]  Set timezone to Australia/Darwin and verify non-hour offset.
    [Tags]  Verify_Set_Timezone_To_Australia_Darwin
    [Template]  Set Timezone And Verify Offset
...
Verify Set Timezone To UTC
    [Documentation]  Set timezone to Etc/UTC and verify zero offset.
    [Tags]  Verify_Set_Timezone_To_UTC
    [Template]  Set Timezone And Verify Offset
