...
Verify Redfish Commands Works Concurrently On Both Interfaces
    [Documentation]  Verify redfish commands works concurrently on both interfaces.
    [Tags]  Verify_Redfish_Commands_Works_Concurrently_On_Both Interfaces 
    ...
    # Deleting added nameservers on eth0 and eth1
    ${dict}=  Execute Process Multi Keyword  ${2}
