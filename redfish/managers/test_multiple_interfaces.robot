...
Verify LDAP Login Works When Eth1 IP Is Not Configured
    ...
    [Setup]  Run Keywords  Set Test Variable  ${CHANNEL_NUMBER}  ${SEC_CHANNEL_NUMBER}
...
Suite Setup Execution
    ...
    ${network_configurations}=  Get Network Configuration Using Channel Number  ${SEC_CHANNEL_NUMBER}
