...
Verify LDAP IP Is Pingable From Eth0
    ...
    ${test_gateway_before}=  Get BMC Default Gateway Of Interface
    ...
    ${test_gateway_after}=  Get BMC Default Gateway Of Interface
...
Get BMC Default Gateway Of Interface
    [Documentation]  Get system default gateway of interface.
    ...
    #${default_gw_first}=  Get From List  ${lines}  0
    #${default_gw}=  Split String  ${default_gw_first}
