...
Create LDAP Configuration On Eth1 IP And Verify When Eth0 IP Broken
    [Documentation]  Create LDAP configurtion on eth1 and verify when eth0 ip address broken.
    [Tags]  Create_LDAP_Configuration_On_Eth1_IP_And_Verify_When_Eth0_IP_Broken
