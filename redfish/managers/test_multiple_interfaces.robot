...
Library         ../../lib/bmc_redfish.py  https://${OPENBMC_HOST_1}:443
...             ${OPENBMC_USERNAME}  ${OPENBMC_PASSWORD}  WITH NAME  Redfish1
...
Verify Able To Load Certificates Via Eth1 IP Address
    ...
    [Setup]  Run Keywords  Redfish.Login  AND  Create Directory  certificate_dir
    ...
    ...  AND  FFDC On Test Case Fail  AND  Redfish.Logout
