...
Library         ../../lib/bmc_redfish.py  https://${OPENBMC_HOST_1}:${HTTPS_PORT}  ${OPENBMC_USERNAME}
...             ${OPENBMC_PASSWORD}  WITH NAME  Redfish1
...
Suite Setup     Set Suite Execution
...
Configure Eth1 With Eth0 Netmask
    ...
    Update Eth1 IP Address Using Eth0 IP Address  ${OPENBMC_HOST_1}  ${ip_address}  ${gateway}  ${netmask}
