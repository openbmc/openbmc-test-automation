...
Configure MAC Settings
    ...
    IF    ${valid_status_code} == ${HTTP_BAD_REQUEST}
        Should Be Equal    ${status}    ${False}    msg=Allowing the configuration of an invalid MAC.
    ELSE
        Should Be Equal    ${status}    ${True}    msg=Not allowing the configuration of a valid MAC.
    END
