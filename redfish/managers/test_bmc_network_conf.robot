...
Add IPv4 Address And Verify
    ...
    Add IPv4 Address  ${BMC_TEST_IPv4_ADDR}
    Delete IPv4 Address  ${BMC_TEST_IPv4_ADDR}
...
Add IPv4 Address
    ...
    ${ip_data}=  Create Dictionary  Address=${BMC_TEST_IPv4_ADDR}
    ...  AddressOrigin=Static  SubnetMask=${BMC_TEST_SUBNET_MASK}
    ...  Gateway=${BMC_TEST_GATEWAY}
    ${list}=  Create List  ${empty_dict}  ${empty_dict}  ${ip_data}
    ${data}=  Create Dictionary  IPv4Addresses=${list}
...
Delete IPv4 Address
    ...
    ${empty_dict}=  Create Dictionary
    ${list}=  Create List  ${null}  ${empty_dict}  ${empty_dict}
    Log To Console  ${list}
    ${data}=  Create Dictionary  IPv4Addresses=${list}
    Redfish.patch  ${REDFISH_NW_ETH0_URI}  body=&{data}
