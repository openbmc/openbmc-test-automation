...
Configure Invalid Netmask
    [Documentation]  Configure invalid netmask.
...
Configure Out Of Range Netmask
    [Documentation]  Configure out of range netmask.
...
Configure Alpha Netmask
    [Documentation]  Configure alpha netmask.
...
Configure More Byte Netmask
    [Documentation]  Configure more byte netmask.
...
Configure Less Byte Netmask
    [Documentation]  Configure less byte netmask.
