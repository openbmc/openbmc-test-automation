...
Modify IPv4 Address And Verify
    ...
    [Teardown]  Run Keywords
    ...  Sleep  ${NETWORK_TIMEOUT}s  AND  Delete IP Address  ${test_ipv4_addr2}
    ...  AND  Delete IP Address  ${test_ipv4_addr}  AND  Test Teardown Execution
...
Update IP Address
    ...
    # new_ip              New IP address to configured.
    ...
    ${ip_data}=  Create Dictionary  Address=${new_ip}
    ...  SubnetMask=${netmask}  Gateway=${gw_ip}
