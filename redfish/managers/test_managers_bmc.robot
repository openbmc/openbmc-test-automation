...
Verify MAC Address Property Is Populated
    ...
    # Example: ([('1', {'name': 'eth0', 'is_valid': True, 'active_sessions': 0,
    #           'channel_info': {'medium_type': 'lan-802.3', 'protocol_type': 'ipmb-1.0',
    #           'session_supported': 'multi-session', 'is_ipmi': True}})])
