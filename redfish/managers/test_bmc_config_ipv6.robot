...
Enable IPMI Via IPv6 Address And Verify IPMI Works For IPv4 And IPv6
    ...
    [Template]  Enable Or Disable IPMI Via IPv6 And Verify It Works For Both IPv4 And IPv6
...
Enable Or Disable IPMI Via IPv6 And Verify It Works For Both IPv4 And IPv6
