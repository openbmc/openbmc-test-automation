...
Verify Redfish Code Update With Different Interrupted Operation
    ...
    ${after_update_activeswimage}=  Run Keyword If  '${operation}' == 'kernel_panic'
    ...  Get Active Firmware Image

    Run Keyword If  '${operation}' == 'kernel_panic'
    ...  Run Keywords  Should Be Equal As Strings
    ...  ${before_update_activeswimage['ActiveSoftwareImage']['@odata.id']}
    ...  ${after_update_activeswimage['ActiveSoftwareImage']['@odata.id']}  AND
    ...  Verify Get ApplyTime  OnReset
    ...
    ${after_update_activeswimage}=  Run Keyword If  '${operation}' == 'host_name'
    ...  Get Active Firmware Image
