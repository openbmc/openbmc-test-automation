...
Redfish Signed Firmware Update
    ...
    Verify BMC Signed Image And Field Mode
...
Verify BMC Signed Image And Field Mode
     [Documentation]  Verify BMC functional image is signed and FieldMode is set to true value.

    Image Should Be Signed
    Field Mode Should Be Enabled
    Print Timen  The functional firmware is signed and field mode is set to true value.
