...
Check Redfish Functional Image Version Is Same
    [Documentation]  Verify functional image version is same as in Redfish managers and also verify when the
    ...  back up image is functional, then the functional image version is same as Redfish managers.
