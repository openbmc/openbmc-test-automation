...
Redfish Upload BMC Image With Invalid Key
    [Documentation]  Upload a BMC firmware with invalid key.
    [Tags]  Redfish_Upload_BMC_Firmware_With_Invalid_key
    [Template]  Redfish Bad Firmware Update
...
Redfish Upload Host Image With Invalid Key
    [Documentation]  Upload a PNOR firmware with invalid key.
    [Tags]  Redfish_Upload_Host_Firmware_With_Invalid_key
    [Template]  Redfish Bad Firmware Update
