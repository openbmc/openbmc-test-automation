...
Redfish Create and Verify Readonly User With Invalid Password Format
    ...
    #username      role_id        password
    admin_user      ReadOnly       snellens
    admin_user      ReadOnly       10000001
    admin_user      ReadOnly       12345678
    admin_user      ReadOnly       abcdefgh
    admin_user      ReadOnly       abf12345
    admin_user      ReadOnly       helloworld
    admin_user      ReadOnly       HELLOWORLD
    admin_user      ReadOnly       &$%**!*@
    admin_user      ReadOnly       Dictation
