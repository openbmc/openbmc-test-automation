...
Logout Of Redfish Administrator
    [Documentation]  Logout Redfish Admin user.
    [Tags]  Logout_Of_Redfish_Administrator
...
Verify ReadOnly Readonly User Privileges Via Redfish
    [Documentation]  Verify ReadOnly user privileges via Redfish.
    [Tags]  Verify_ReadOnly_Readonly_User_Privileges_Via_Redfish
...
Login Redfish Default Admin User To Delete Created Users
    [Documentation]  Login Redfish Admin User.
    [Tags]  Login_Redfish_Default_Admin_User_To_Delete_Created_Users
...
Redfish Verify User
    [Documentation]  Verify Redfish user verification with given credentials.
