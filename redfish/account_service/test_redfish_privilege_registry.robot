...
Suite Setup      Create Various Privilege Level Users
...
Create Various Privilege Level Users
    [Documentation]  Create admin, test, operator, and readonly users.
...
Teardown Actions
    [Documentation]  Perform Redfish logout as teardown for each test case.
