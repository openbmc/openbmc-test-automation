...
Suite Teardown   Run Keywords  Disable Other AD  AND  Redfish.Logout
...
Update AD Config And Verify Set Host Name
    ...
    Run Keyword If  '${group_privilege}'=='NoAccess'  Verifying redfish Login for AD userRole NoAccess
...
Verifying redfish Login for AD userRole NoAccess
