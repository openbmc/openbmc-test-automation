...
LDAP User Creates Local User And Privilege Change By Local User
    ...
    # Validate changer_type argument value before proceeding.
    Should Be True  '${changer_type}' in ['Local_Admin', 'Local_ReadOnly']
    ...  msg=Invalid changer_type '${changer_type}': must be 'Local_Admin' or 'Local_ReadOnly'.
