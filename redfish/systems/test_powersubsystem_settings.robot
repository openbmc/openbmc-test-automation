...
Verify State Of PowerSubsystem PowerSupplies
    ...
    ${resp}=  Redfish.Get  ${REDFISH_CHASSIS_POWERSUBSYSTEM_SUPPLIES_URI}
...
Get Total Number Of PowerSupplies
    ...
    ${total_num_powersupplies}=  Redfish.Get Attribute  ${REDFISH_CHASSIS_POWERSUBSYSTEM_SUPPLIES_URI}  Members@odata.count
