...
Variables        ../../data/standard_sensor_value_map.py
...
Required Parameters For Sensor Monitoring
    ...
    Should Not Be Empty   ${KEYFILE}
    Should Be True        ${REQKEY}
    Should Not Be Empty   ${OPENBMC_CONN_METHOD}
    ...
    Should Be Equal As Strings  ${IPMI_COMMAND}  Inband
    Should Not Be Empty  ${CHASSIS_ID}
