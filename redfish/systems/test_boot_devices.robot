...
Set And Verify BootSource And BootType
    ...
    ${resp}=  redfish_utils.Get Attribute /redfish/v1/Systems/system   Boot
    Should Be Equal As Strings  ${resp["BootSourceOverrideEnabled"]}
    ...  ${override_enabled}
    Should Be Equal As Strings  ${resp["BootSourceOverrideTarget"]}
    ...  ${override_target}
    Sleep  30s
