...
Get Power Supplies Input Watts
    [Documentation]  Get the power supply input watts.
    [Tags]  Get_Power_Supplies_Input_Watts
    [Template]  Get Watts Record and Verify
...
Get Power Supplies Input Output Voltages
    [Documentation]  Get the power supply voltages .
    [Tags]  Get_Power_Supplies_Input_Output_Voltages
...
Get Watts Record and Verify
    [Documentation]  Get the power watt records.
