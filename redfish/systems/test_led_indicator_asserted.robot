...
Verify LED Lamp Test Asserted At Standby
    ...
    # pre_req_state     assert       expected_indicator_led
    Off                 1            Blinking
    Off                 0            Off
...
Verify LED Power Supply Units Asserted At Runtime
    ...
    # pre_req_state     assert                                          expected_indicator_led
    Running             "xyz.openbmc_project.Led.Physical.Action.On"    Lit
    Running             "xyz.openbmc_project.Led.Physical.Action.Off"   Off
...
Set and Verify Lamp LED Indicator
    ...
    [Arguments]  ${pre_req_state}  ${assert}  ${expected_indicator_led}

    # Description of Arguments(s):
    # pre_req_state           The pre-requisite state of the host to perform the test (e.g. "On")
    # assert                  The assert property that sets the value to 0 - Off or 1 - Blinking (e.g. "1")
    ...
    Redfish.Put  ${LED_LAMP_TEST_ASSERTED_URI}attr/Asserted  body={"data":${assert}}
...
Set and Verify LED Indicator
    ...
    # Description of Arguments(s):
    # pre_req_state           The pre-requisite state of the host to perform the test (e.g. "On")
    # assert                  The assert property that sets the value (e.g. "xyz.openbmc_project.Led.Physical.Action.On")
    # expected_indicator_led  The expected value of the IndicatorLED attribute for all the
    ...
    Redfish.Put  ${LED_PHYSICAL_PS0_URI}attr/State  body={"data":${assert}}
    Redfish.Put  ${LED_PHYSICAL_PS1_URI}attr/State  body={"data":${assert}}
