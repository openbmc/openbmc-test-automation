...
Verify LED Lamp Test Asserted At Standby
    ...
    # pre_req_state     set_assert_property     expected_indicator_led
    Off                 1                       Blinking
    Off                 0                       Off
...
Verify LED Power Supply Units Asserted At Runtime
    ...
    # pre_req_state     set_assert_property                             expected_indicator_led
    Lit                 "xyz.openbmc_project.Led.Physical.Action.On"    Lit
    Off                 "xyz.openbmc_project.Led.Physical.Action.Off"   Off
...
Set and Verify Lamp LED Indicator
    ...
    [Arguments]  ${pre_req_state}  ${set_assert_property}  ${expected_indicator_led}

    # Description of Arguments(s):
    # pre_req_state           The pre-requisite state of the host to perform the test (e.g. "Running")
    # set_assert_property     The assert property that sets the value to 0 - Off or 1 - Blinking (e.g. "1")
    ...
    Set Initial Test State  ${pre_req_state}
    Redfish.Put  ${LED_LAMP_TEST_ASSERTED_URI}attr/Asserted  body={"data":${set_assert_property}}
...
Set and Verify LED Indicator
    ...
    # Description of Arguments(s):
    # pre_req_state           The pre-requisite state of the host to perform the test (e.g. "Running")
    # set_assert_property     The assert property that sets the value (e.g. "xyz.openbmc_project.Led.Physical.Action.On")
    # expected_indicator_led  The expected value of the IndicatorLED attribute for all the
    ...
    Redfish.Put  ${LED_PHYSICAL_PS0_URI}attr/State  body={"data":${set_assert_property}}
    Redfish.Put  ${LED_PHYSICAL_PS1_URI}attr/State  body={"data":${set_assert_property}}
...
Verify Indicator LEDs
    ...
    ${led_indicators}=  Redfish.Get Attribute  ${REDFISH_CHASSIS_POWER_URI}  PowerSupplies
    Rprint Vars  led_indicators
    FOR  ${power_supply_leds}  IN  @{led_indicators}
