...
Verify LED Lamp Test Asserted At Standby
    ...
    # expected_indicator_led     set_assert_property       pre_req_state
    Blinking                     1                         Off
    Off                          0                         Off
...
Verify LED Power Supply Units Asserted At Standby
    ...
    # expected_indicator_led    set_assert_property                             pre_req_state
    Lit                         "xyz.openbmc_project.Led.Physical.Action.On"    Off
...
Set and Verify Lamp LED Indicator
    ...
    [Arguments]  ${expected_indicator_led}  ${set_assert_property}  ${pre_req_state}
    ...
    Redfish.Put  ${LED_LAMP_TEST_ASSERTED_URI}  body={"data":${set_assert_property}}
...
Set and Verify LED Indicator
    ...
    Redfish.Put  ${LED_PHYSICAL_PS0_URI}  body={"data":${set_assert_property}}
    Redfish.Put  ${LED_PHYSICAL_PS1_URI}  body={"data":${set_assert_property}}
