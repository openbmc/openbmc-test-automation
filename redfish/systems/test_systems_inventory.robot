...
# The passing criteria.  Must have at least this many of each.
${min_count_dimm}   2
${min_count_cpu}    1
...
Is Item Enabled And Health Ok
    ...
    # resource      An indifidual resource to check, for example,
    #                /redfish/v1/Systems/system/Memory/dimm0
    ...
    # keep processing if resource = "/redfish/v1/Systems/system/Memory/dimm1".
...
Test Teardown Execution
    ...
    Log To Console  ===== SMS doing test teardown ======
