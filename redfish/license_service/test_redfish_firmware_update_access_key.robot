...
Check Firmware Update Access Key Attributes
    ...
    Verify Firmware Update Access Key Inventory  ${resp}
...
Verify Firmware Update Access Key Inventory
    [Documentation]  Capture all the Redfish firmware update access key URI attribute and store in dictionary.
