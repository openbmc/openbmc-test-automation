*** Settings ***
Documentation   This suite verifies the power restore policy setting at
...             at various host states after BMC reboot.
...
Test Tags      Power_Restore_Reboot


*** Test Cases ***

Test Restore Policy ALWAYS_POWER_ON With Host Running After Reboot
    [Documentation]  Verify the BMC restore policy is ALWAYS_POWER_ON while the Host is running
    ...  after BMC reboot.
    [Tags]  Test_Restore_Policy_ALWAYS_POWER_ON_With_Host_Running_After_Reboot
    [Template]  Verify Restore Policy After Reboot

    # Policy                Initial Host State     Expected Host State
    AlwaysOn                Running                Running


Test Restore Policy ALWAYS_POWER_ON With Host Off After Reboot
    [Documentation]  Validate ALWAYS_POWER_ON restore policy functionality after BMC reboot.
    ...              Policy:
    ...
    ...                    specific state.
    [Tags]  Test_Restore_Policy_ALWAYS_POWER_ON_With_Host_Off_After_Reboot
    [Template]  Verify Restore Policy After Reboot
...
Test Restore Policy ALWAYS_POWER_OFF With Host Off After Reboot
    [Documentation]  Validate ALWAYS_POWER_OFF restore policy functionality after BMC reboot.
    ...              Policy:
    ...                    System policy set to ALWAYS_POWER_OFF.
    ...              Initial Host State:
    ...                    State where system should be before running the
    ...
    ...                    After BMC reset, system should reach this
    ...                    specific state.
    [Tags]  Test_Restore_Policy_ALWAYS_POWER_OFF_With_Host_Off_After_Reboot
    [Template]  Verify Restore Policy After Reboot
...
Test Restore Policy ALWAYS_POWER_OFF With Host Running After Reboot
    [Documentation]  Verify that the BMC restore policy is ALWAYS_POWER_OFF while the Host is running
    ...  after BMC reboot.
    [Tags]  Test_Restore_Policy_ALWAYS_POWER_OFF_With_Host_Running_After_Reboot
    [Template]  Verify Restore Policy After Reboot
...
Test Restore Policy Restore Last State With Host Running After Reboot
    [Documentation]  Validate RESTORE_LAST_STATE restore policy functionality after BMC reboot.
    ...              Policy:
    ...
    ...                    After BMC reset, system should reach this
    ...                    specific state.
    [Tags]  Test_Restore_Policy_Restore_Last_State_With_Host_Running_After_Reboot
    [Template]  Verify Restore Policy After Reboot
...
Test Restore Policy Restore Last State With Host Off After Reboot
...
Verify Restore Policy After Reboot
...
Suite Teardown Execution
    ...
    Run Keyword And Ignore Error  Redfish Set Power Restore Policy  AlwaysOn
    Redfish.Logout
