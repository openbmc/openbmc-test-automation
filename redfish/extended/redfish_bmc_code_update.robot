...
Redfish BMC Code Update Current And Alternate Side With Same Image Version
    [Documentation]  Perform update the firmware image back to back on both
    ...              the functional and alternate image with same version.
    [Tags]  Redfish_BMC_Code_Update_Current_And_Alternate_Side_With_Same_Image_Version
