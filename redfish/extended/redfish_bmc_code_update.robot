...
Redfish BMC Code Update Running And Backup Image With Same Firmware
    [Documentation]  Perform the firmware update with same image back to back,
    ...              so that the functional and alternate image with same firmware.
    [Tags]  Redfish_BMC Code_Update_Running_And_Backup_Image_With_Same_Firmware
