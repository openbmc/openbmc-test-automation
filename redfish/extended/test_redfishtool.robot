...
Verify Redfishtool usermanagement Commands
    ...
    Verify Update User  ${user_name}  ${newRoldId}
...
Verify Create User
    ...
    ${Data}=   Set Variable   '{"UserName":${user_name},"Password":${Password},"RoleId":${DefaultRoleId},"Enabled":true}'
...
Verify Update User
    ...
    Verify User Role  ${user_name}  ${newRole}
