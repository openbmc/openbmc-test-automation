...
Wait For Task Completion
    ...
    FOR  ${retry}  IN RANGE  ${retry_max_count}
        ...
        ${out}=  Evaluate  '${resp["TaskState"]}' in ${expected_completion_state}
...
Load Task Service Properties Data
    [Documentation]  Load the task_service_properties.json file and get the task service
    ...  related variable values.

    ${json}=  OperatingSystem.Get File  data/task_service_properties.json
