...
Verify Basic Periodic Telemetry Report Creation
    ...
    ...  "Name": "Report",
    ...  "ReportActions":["LogToMetricReportsCollection"],
    ...  "Metrics":[{"CollectionDuration": "PT30.000S","CollectionFunction": "Average","MetricProperties":${resp["MetricProperties"]}}],
    ...
    Redfish.Get  ${metric_report_base_uri}/Test_basic_periodic_report_ambient_temp
     ...  valid_status_codes=[${HTTP_OK}]
