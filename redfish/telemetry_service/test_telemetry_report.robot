...
Verify Telemetry Service MetricReports Unsupported Methods
    ...
    Verify Supported And Unsupported Methods    uri=${REDFISH_TELEMETRY_URI}/MetricReports
...
Verify Telemetry Service Defaults
    ...
    Valid Value  telemetryservice['MetricReportDefinitions']['@odata.id']
    ...    ['/redfish/v1/TelemetryService/MetricReportDefinitions']
    Valid Value  telemetryservice['MetricReports']['@odata.id']
...
Verify Metric Reports Defaults
    ...
    ${metric_reports}=  Redfish.Get Properties  ${metric_report_base_uri}
    ...  valid_status_codes=[${HTTP_OK}]

    ${metric_reports_count}=  Get Length  ${metric_reports['Members']}

    Valid Value  metric_reports['@odata.id']  ['${metric_report_base_uri}', '${metric_report_base_uri}/']
