...
Verify Basic Telemetry Report Creation
    ...
    Create Basic Telemetry Report  ${total_power_metric}          total_power_metric_report          success
    Create Basic Telemetry Report  ${ambient_temp_metric}         ambient_temp_metric_report         success
    Create Basic Telemetry Report  ${battery_voltage_metric}      processor_core_temp_metric_report  success
    Create Basic Telemetry Report  ${proc_core_temp_metric}       processor_mem_temp_metric_report   success
    Create Basic Telemetry Report  ${pcie_temp_metric}            pcie_temp_metric_report            success
    Create Basic Telemetry Report  ${dimm_temp_metric}            dimm_temp_metric_report            success
    Create Basic Telemetry Report  ${relative_humidity_metric}    relative_humidity_metric_report    success
    Create Basic Telemetry Report  ${pcie_power_metric}           pcie_power_metric_report           success
    Create Basic Telemetry Report  ${io_power_metric}             io_power_metric_report             success
