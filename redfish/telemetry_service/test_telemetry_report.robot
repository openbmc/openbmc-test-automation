...
Create Basic Telemetry Report
    ...
    [Arguments]  ${metric}   ${report_name}  ${expected_result}=success

    # Description of argument(s):
    # metric                    Name of Metric Definition's property in reporty like Ambient_0_Temp.
    # report_name               Name of telemetry report which needs to be created.
    # expected_result           Expected result of report creation.
