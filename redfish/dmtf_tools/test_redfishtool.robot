...
Verify Redfishtool Create Users
    ...
    Redfishtool verify User Exists  "UserT100"  "Operator"
...
Redfishtool Verify User Role
    ...
    ${result}=  Run Keyword If   "${json_obj["RoleId"]}" == ${role}  Set Variable  True
    Should Be True  ${result}
 
Redfishtool Verify User Exists
    [Documentation]  Verify an user exists with the name and role.
    [Arguments]  ${user_name}  ${role}
