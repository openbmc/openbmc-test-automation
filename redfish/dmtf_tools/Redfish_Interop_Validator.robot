...
...  https://raw.githubusercontent.com/opencomputeproject/HWMgmt-OCP-Profiles/master/OCPBaselineHardwareManagement.v1_1_0.json
${ocp_server_profile_url}
...  https://raw.githubusercontent.com/opencomputeproject/HWMgmt-OCP-Profiles/master/Server/OCPServerHardwareManagement.v1_1_0.json
...
Test BMC Redfish Using Redfish Interop Validator-OCP Hard Manag Profiles v1_1_0
    ...
    [Tags]  Test_BMC_Redfish_Using_Redfish_Interop_Validator-OCP_Hard_Manag_Profiles_v1_1_0
    ...
    IF  ${rc} != 0  Fail  Redfish-Interop-Validator Failed for OCP Hardware Management profiles.
...
Download OCP Profiles
    ...
    Shell Cmd  wget -q -O ${ocp_baseline_profile_path} ${ocp_baseline_profile_url}
    Shell Cmd  wget -q -O ${ocp_server_profile_path} ${ocp_server_profile_url}
