...
ID_LOOKUP = {
    ...
    'SENSOR': {
        ...
        0x0b: '/xyz/openbmc_project/control/power_supply_redundancy/attr/PowerSupplyRedundancyEnabled',
        0xda: '/xyz/openbmc_project/control/host0/turbo_allowed/attr/TurboAllowed',
        0xD8: '/xyz/openbmc_project/control/power_supply/attr/DeratingFactor',
    },
    'GPIO_PRESENT': {}
}
