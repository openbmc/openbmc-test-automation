...
CMD_GETBIOSTABLE = 'bios GetBIOSTable -t %s'
'''
e.g. : GetBIOSTable usage

pldmtool bios GetBIOSTable -t <biostable_type>

StringTable->0,AttributeTable->1,AttributeValueTable->2
...
RESPONSE_DICT_GETFRURECORDTABLEMETADATA = {
    ...
    'fru_datastructuretableintegritychecksum': '2516700077'}
