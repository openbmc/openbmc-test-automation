...
PLDM_TYPE_OEMIBM = {'VALUE': '63', 'STRING': 'oem-ibm'}
...
VERSION_OEMIBM = {'VALUE': ['f1', 'f0', 'f0', '00'], 'STRING': '1.0.0'}
...
PLDM_OEMIBM_CMDS = ['1(GetFileTable)', '4(ReadFile)', '5(WriteFile)', '6(ReadFileInToMemory)', '7(WriteFileFromMemory)', '8(ReadFileByTypeIntoMemory)', '9(WriteFileByTypeFromMemory)', '10(NewFileAvailable)', '11(ReadFileByType)', '12(WriteFileByType)', '13(FileAck)', '240(GetAlertStatus)']
