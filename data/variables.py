...
HOST_INTERFACE_URI = (
    REDFISH_BASE_URI + "Managers/" + REDFISH_MANAGERS_ID + "/HostInterfaces/rhi"
)
MANAGER_RESET_URI = (
    REDFISH_BASE_URI + "Managers/" + REDFISH_MANAGERS_ID + "/Actions/Manager.Reset"
)
...
REDFISH_TASKS_URI = REDFISH_TASK_SERVICE_URI + "Tasks"

# Event variables.
REDFISH_EVENT_SERVICE_URI = REDFISH_BASE_URI + "EventService/"
REDFISH_SUBSCRIPTION_URI = REDFISH_EVENT_SERVICE_URI + "Subscriptions"
