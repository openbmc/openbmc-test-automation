...
REDFISH_NW_ETH_IFACE = REDFISH_BASE_URI + 'Managers/' + REDFISH_MANAGERS_ID + '/EthernetInterfaces/'
...
REDFISH_HTTPS_CERTIFICATE = 'Managers/' + REDFISH_MANAGERS_ID + '/NetworkProtocol/HTTPS/Certificates'
