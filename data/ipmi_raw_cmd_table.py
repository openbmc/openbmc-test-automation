...
IPMI_RAW_CMD = {
    ...
    'Watchdog':
    {
        ...
        [
            ...
            "none",
            "timeout action PowerCycle",
            "0x06 0x24 0x05 0x00 0x00 0x02 0x00 0x00",
            "none",
            "timeout flag FRB2",
            "0x06 0x24 0x05 0x00 0x00 0x04 0x00 0x00",
            "none",
            "timeout flag POST",
            "0x06 0x24 0x05 0x00 0x00 0x08 0x00 0x00",
            "none",
            "timeout flag OS",
            "0x06 0x24 0x05 0x00 0x00 0x10 0x00 0x00",
            "none",
            "timeout flag SMS",
            "0x06 0x24 0x05 0x00 0x00 0x20 0x00 0x00",
            "none",
            "timeout flag OEM",
            ...
            "none",
            "No action",
            "0x06 0x24 0x05 0x00 0x00 0x00 0x30 0x35",
            "none",
