...
IPMI_RAW_CMD = {
    ...
    "lan_parameters": {
        "get_ip": [
            # raw command
            "0x0c 0x02 0x0"+BuiltIn().get_variable_value("${CHANNEL_NUMBER}")+" 0x03 0 0"
        ],
        "get_ip_src": [
            # raw command
            "0x0c 0x02 0x0"+BuiltIn().get_variable_value("${CHANNEL_NUMBER}")+" 0x04 0 0"
        ],
        "get_dot1q": [
            # raw command
            "0x0c 0x02 0x0"+BuiltIn().get_variable_value("${CHANNEL_NUMBER}")+" 0x14 0 0"
        ],
    },
    "SDR_Info": {
        "get": [
