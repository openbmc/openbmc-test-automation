...
IPMI_RAW_CMD = {
    ...
    "user_name": {
        "Set": [
            # invalid data length less byte
            "0x06 0x45 0x05 0x61 0x32 0x33 0x34 0x35 0x36 0x37 0x38 0x39 0x30 0x31 0x32 0x33 0x34 0x35",
            # invalid data length extra byte
            "0x06 0x45 0x05 0x61 0x32 0x33 0x34 0x35 0x36 0x37 0x38 0x39 0x30 0x31 0x32 0x33 0x34 0x35 0x36 0x37",
        ]
    },
    "chssis_power_policy": {
        "Set": [
