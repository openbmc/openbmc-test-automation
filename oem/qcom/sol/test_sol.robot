...
...              - Raspberry Pi5 (RPI) connected to AST2600 EVB via UART (ttyS3)
...              - Connection: TXD4/GPIO12(RPI) <-> BMC_UART_RXD4(EVB)
...                            RXD4/GPIO13(RPI) <-> BMC_UART_TXD4(EVB)
...              - SOL on EVB provides console access to RPI
