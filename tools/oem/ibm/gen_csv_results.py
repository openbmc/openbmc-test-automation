...
parser = argparse.ArgumentParser(
    ...
    description="%(prog)s -s <source path> -d <destination path>",
...
parser.add_argument(
    '--source',
    '-s',
    help='\t-s | --source=  : The output.xml robot test result file path.')

parser.add_argument(
    '--dest',
    '-d',
    help='\t-d | --dest=    : The directory path where the generated .csv files will go.')
...
def parse_output_xml(xml_file_path, csv_dir_path):
    ...
    r"""
    Parse the robot generated output.xml file produced and extract various test
    output data. Put the extracted information into a csv file in the "dest" folder.

    Description of argument(s):
    xml_file_path  The path to a Robot-generated output.xml file.
    csv_dir_path   The path to the directory that is to contain the .csv files generated by this function.
    """
