...
def parse_output_xml(xml_file_path, csv_dir_path):
    ...
    r"""
    Parses the robot generated output.xml file produced and extracts various test
    output data. The extracted information is put into in a csv file in a specific
    idestination folder.

    Description of arguments:
        xml_file_path  Robot generated output.xml with complete path, used as source.
        csv_dir_path   Destination folder where .csv file is generated.
    """
...
def main(argv):
    ...
    # Program specific customized code below
