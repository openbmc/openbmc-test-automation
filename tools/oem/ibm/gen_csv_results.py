...
parser = argparse.ArgumentParser(
    ...
    description="%(prog)s uses a robot framework API to extract test result data from output.xml generated by robot tests. For more information on the Robot Framework API, see http://robot-framework.readthedocs.io/en/3.0/autodoc/robot.result.html and https://gerrit.openbmc-project.xyz/#/c/8885/15/tools/oem/ibm/gen_csv_results.py",
