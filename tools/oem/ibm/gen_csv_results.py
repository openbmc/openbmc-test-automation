...
parser.add_argument(
    ...
    help='Driver version of openbmc firmware which was used during test,\
          e.g. "ibm-v2.1-105-g4397421-r1-0-gbeb0b18".')
...
def parse_output_xml(xml_file_path, csv_dir_path, driver_version):
    ...
    driver_version  Version of the openbmc firmware
                    (e.g. "ibm-v2.1-105-g4397421-r1-0-gbeb0b18").
    """
    ...
    if l_system_info[0]:
        ...
        l_driver = driver_version
    if l_driver:
        print "Driver info set."
    else:
        print "Driver version is not set. CSV file is not generated."
        sys.exit()
    if l_system_info[1]:
        l_platform_type = l_system_info[1]
        print "System info set."
    else:
        print "System model is not set. CSV file is not generated."
        sys.exit()
...
def main():
    ...
    parse_output_xml(source, dest, version_id)
