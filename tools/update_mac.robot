*** Settings ***
Documentation  Comapare and update BMC MAC address with input MAC
...
Check And Reset MAC
    [Documentation]   Get BMC System MAC address and compare/update with input.


    Open Telnet Connection to BMC Serial Console
    ${output}=  Telnet.Execute Command  cat /sys/class/net/eth0/address  strip_prompt=True
