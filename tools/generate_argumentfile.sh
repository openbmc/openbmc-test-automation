...
echo "--variable IPMITOOL_HOST:$IPMITOOL_HOST" >> $ARG_FILE
echo "--variable IPMITOOL_HOST_USERNAME:$IPMITOOL_HOST_USERNAME" >> $ARG_FILE
echo "--variable IPMITOOL_HOST_PWD:$IPMITOOL_HOST_PWD" >> $ARG_FILE
echo "--variable IPMITOOL_PATH:$IPMITOOL_PATH" >> $ARG_FILE
