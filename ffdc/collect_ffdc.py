...
def cli_ffdc(
    ...
    if input_options_ok(remote, username, password, port_https, port_ipmi, config, type):
...
def input_options_ok(remote, username, password, port_https, port_ipmi, config, type):
    r"""
